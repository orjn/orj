...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/orj/orj/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # orj, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'orj_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~orj.tools.misc.html_escape`.
...
def generate_tracking_message_id(res_id):
    ...
    try:
        ...
        rnd = random.random()
    rndstr = ("%.15f" % rnd)[2:]
    return "<%s.%.15f-orj-%s@%s>" % (rndstr, time.time(), res_id, socket.gethostname())
...
def email_normalize(text, strict=True):
    ...
    within orj, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within orj, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@orj.net
    * Output: "Admin" <notifications@orj.net>
    """
