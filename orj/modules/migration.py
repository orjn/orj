...
VERSION_RE = re.compile(
    r"""^
        # Optional prefix with Orj version
        ((
            6\.1|
        ...
        # After Orj version we allow precisely 2 or 3 parts
...
class MigrationManager(object):
    ...
    def _get_files(self):
        def _get_upgrade_path(pkg):
            for path in orj.upgrade.__path__:
    ...
    def migrate_module(self, pkg, stage):
        ...
        def compare(version):
            ...
            if majorless_version:
                # We should not re-execute major-less scripts when upgrading to new Orj version
