...
"""The Orj API module defines Orj Environments and method decorators.
...
from orj.tools.misc import StackMap
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~orj.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~orj.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/orj/orj/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~orj.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~orj.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~orj.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~orj.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in orj.tools.file_open_temporary_directory)
