...
product_name = 'Orj'
description = 'Orj Server'
long_desc = '''Orj is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'Orj S.A.'
author_email = 'info@orj.net'
license = 'LGPL-3'

nt_service_name = "orj-server-" + series.replace('~','-')
