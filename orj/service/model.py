...
from orj.tools import DotDict, lazy
from orj.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(orj.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param orj.api.Environment env: The environment where the registry
