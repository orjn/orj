...
ORJ_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('ORJ_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('orj.tests.stats')
...
class OrjTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= ORJ_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", ORJ_TEST_MAX_FAILED_TESTS)
