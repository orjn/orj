...
term representation was ['=', 'company_id.name', 'Orj']. Used in a
...
Orj will use the SQL function 'unaccent' when available for the
...
Finally, to instruct Orj to really use the unaccent function, you have to
...
import orj.modules
from orj.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from orj.tools import Query, SQL, get_lang
from orj.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return orj.modules.registry.Registry(cr.dbname).unaccent
