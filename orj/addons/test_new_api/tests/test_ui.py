...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/orj/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@orj.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(orj.tests.HttpCase):

    @mute_logger('orj.sql_db', 'orj.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/orj/action-test_new_api.action_categories",
