...
from orj.tests import Form, TransactionCase, users
from orj.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('orj.models.unlink', 'orj.fields')
    ...
    @users('test')
    @mute_logger('orj.addons.base.models.ir_rule', 'orj.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('orj.addons.test_new_api.models.test_new_api.MultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('orj.addons.test_new_api.models.test_new_api.Discussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('orj.fields', 'orj.models.unlink')
