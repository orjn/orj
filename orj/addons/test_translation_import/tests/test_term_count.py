...
from orj.tools.misc import file_open, mute_logger, file_path
from orj.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, TranslationFileReader
from orj import Command
from orj.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('orj.addons.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        self.assertEqual(set(terms), {
            ...
            'Scorecard title',
            'Opportunities',
            'Orj Chart horizontal axis title',
            'Orj Chart vertical axis title'
        })
