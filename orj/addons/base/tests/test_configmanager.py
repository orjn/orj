...
from orj.tools import file_path, file_open, file_open_temporary_directory
from orj.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in orj.tools.config.options
ROOT_PATH = orj.tools.config.options['root_path'].removesuffix('/orj')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', orj.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', orj.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/orj/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
            'pre_upgrade_scripts': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/orj',  # blacklist for save, ignored from the config file
    ...
    def test_04_orj16_config_file(self):
        # test that loading the Orj 16.0 generated default config works
