...
from orj.tests import BaseCase, TransactionCase, tagged, BaseCase
from orj.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when ORJ_TEST_FAILURE_RETRIES is set"""
