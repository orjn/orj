...
from orj.sql_db import db_connect, TestCursor
from orj.tests import common
from orj.tests.common import BaseCase, HttpCase
from orj.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = orj.api.Environment(self.cr, orj.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('orj.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:orj.sql_db:Found different un-closed cursor', msg)
