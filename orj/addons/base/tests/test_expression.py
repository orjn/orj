...
from orj.addons.base.tests.common import SavepointCaseWithUserDemo
from orj.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('orj.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have Orj has a parent company, you expect to find,
    ...
    def test_like_cast(self):
        ...
        with mute_logger('orj.sql_db'), self.assertRaises(psycopg2.Error):
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of Orj Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
