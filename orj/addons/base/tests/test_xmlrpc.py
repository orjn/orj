...
from orj.exceptions import AccessDenied, AccessError
from orj.http import _request_stack

import orj
import orj.tools
from orj.tests import common
from orj.service import common as auth, model
from orj.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   orj.api.model(lambda *_: collections.defaultdict(int)))
