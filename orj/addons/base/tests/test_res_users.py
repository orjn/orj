...
from orj.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from orj.exceptions import UserError, ValidationError
from orj.http import _request_stack
from orj.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('orj.sql_db', 'orj.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('orj.addons.base.models.res_users.request', request)
