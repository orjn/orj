...
from orj.addons.base.models.ir_qweb import QWebException, render
from orj.tools import misc, mute_logger
from orj.tools.json import scriptsafe as json_scriptsafe
from orj.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://orj.net/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/orj/sub">link</a>
                <a href="/link/orj/">link2</a>
            """
        values = {'url': 'orj', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('orj.addons.base.models.ir_qweb') # warning for template not found
