...
import orj
from orj import api, http, models, tools, SUPERUSER_ID
from orj.exceptions import AccessDenied
from orj.http import request, Response, ROUTING_KEYS
from orj.modules.registry import Registry
from orj.service import security
from orj.tools.json import json_default
from orj.tools.misc import get_lang, submap
from orj.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and orj.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (orj.exceptions.AccessError, orj.exceptions.MissingError) as e:
                ...
                if isinstance(e, orj.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(orj.conf.server_wide_modules)
    ...
    def _gc_sessions(self):
        if os.getenv("ORJ_SKIP_GC_SESSIONS"):
            return
