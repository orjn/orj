...
from orj import api, Command, fields, models
from orj.tools import OrderedSet
from orj.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an orj
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`orj.osv.orm.Model.write` expects.

        :param model: :class:`orj.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`orj.fields.Field`
