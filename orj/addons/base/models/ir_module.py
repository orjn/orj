...
import orj
from orj import api, fields, models, modules, tools, _
from orj.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from orj.exceptions import AccessDenied, UserError, ValidationError
from orj.osv import expression
from orj.tools.parse_version import parse_version
from orj.tools.misc import topological_sort, get_flag
from orj.tools.translate import TranslationImporter, get_po_paths
from orj.http import request
from orj.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Orj 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Orj 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Orj Ore Edition License v1.0'),
        ('OPL-1', 'Orj Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Orj Ore Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Orj is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(orj.conf.server_wide_modules) & set(self.mapped('name'))
