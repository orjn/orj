...
from orj import api, fields, models, SUPERUSER_ID, tools, _
from orj.exceptions import AccessError, ValidationError, UserError
from orj.http import Stream, root, request
from orj.tools import config, human_size, image, str2bool, consteq
from orj.tools.mimetypes import guess_mimetype, fix_filename_extension
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any orj document.
