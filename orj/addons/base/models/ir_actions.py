...
import orj
from orj import api, fields, models, tools, _, Command
from orj.exceptions import MissingError, ValidationError, AccessError, UserError
from orj.tools import frozendict
from orj.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since Orj 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': orj.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
