...
from orj.exceptions import MissingError, UserError
from orj.http import Stream, request
from orj.tools import file_open, replace_exceptions
from orj.tools.image import image_process, image_guess_size_from_field_name
from orj.tools.mimetypes import guess_mimetype, get_extension
from orj.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:orj.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~orj.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`orj.tools.image.image_process`.
