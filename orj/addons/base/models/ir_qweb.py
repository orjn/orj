...
QWeb is the primary templating engine used by Orj. It is an XML templating
...
<https://www.orj.net/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed orj user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Orj method from ``res.users`` model.
...
from orj import api, models, tools
from orj.modules import registry
from orj.tools import config, safe_eval, pycompat
from orj.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from orj.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from orj.tools.json import scriptsafe
from orj.tools.lru import LRU
from orj.tools.misc import str2bool
from orj.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from orj.http import request
from orj.tools.profiler import QwebTracker
from orj.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from orj.addons.base.models.assetsbundle import AssetsBundle
from orj.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Orj 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__orjAssetError=1"
