...
import orj
from orj.tests import new_test_user, tagged, RecordCapturer
from orj.tools import config, file_open, image_process
from orj.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([orj.SUPERUSER_ID])
