...
from orj.tests.common import new_test_user, Like
from orj.tools import mute_logger
from orj.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('orj.http', 'WARNING') as capture_http,\
             self.assertLogs('orj.sql_db', 'WARNING') as capture_sql_db:
