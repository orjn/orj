...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('orj.http'):
    ...
    def test_01_create(self):
        ...
        try:
            with mute_logger("orj.sql_db", "orj.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("orj.sql_db"), mute_logger("orj.http"):
