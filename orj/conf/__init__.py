...
For now, configuration code is in orj.tools.config. It is in mainly
...
To initialize properly this module, orj.tools.config.parse_config()
must be used.

"""

# Paths to search for Orj addons.
addons_paths = []
...
# installed (i.e. the majority of Orj addons). This is set with the --load
# command-line option.
server_wide_modules = []
