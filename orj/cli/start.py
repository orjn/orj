...
from orj.modules.module import get_module_root, MANIFEST_NAMES
from orj.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the orj server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            orj.tools.config['init']['base'] = True
