...
from orj.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    def run(self, args):
        parser = argparse.ArgumentParser(
            ...
            description="""\
Orj cloc is a tool to count the number of relevant lines written in
...
It has two modes of operation, either by providing a path:
    ...
    orj-bin cloc -p module_path

Or by providing the name of a database:

    orj-bin cloc --addons-path=dirs -d database
