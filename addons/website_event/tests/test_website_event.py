...
from orj.addons.website_event.tests.common import TestEventOnlineCommon, OnlineEventCase
...
class TestEventRegisterUTM(HttpCase, TestEventOnlineCommon):
    def test_event_registration_utm_values(self):
        ...
        self.opener.cookies.update({
            'orj_utm_campaign': event_campaign.name,
            'orj_utm_source': self.env.ref('utm.utm_source_newsletter').name,
            'orj_utm_medium': self.env.ref('utm.utm_medium_email').name
        })
