...
from orj.tests import Form, HttpCase, tagged, warmup
from orj.addons.mail.tests.common import MailCase
from orj.addons.marketing_card.controllers.marketing_card import SOCIAL_NETWORK_USER_AGENTS
...
class TestMarketingCardRender(MarketingCardCommon):
    ...
    def test_campaign(self):
        ...
        with patch('orj.addons.marketing_card.models.card_campaign.CardCampaign._get_model_selection',
