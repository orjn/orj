{
    'name': 'Orj 18 Accounting Financial Reports',
    'version': '1.0.2',
    'category': 'Invoicing Management',
    'description': 'Accounting Reports For Orj 18, Accounting Financial Reports, '
                   'Orj 18 Financial Reports',
    'summary': 'Accounting Reports For Orj 18',
    'sequence': '1',
    'author': 'Orj, Orj SA',
    'license': 'LGPL-3',
    'company': 'Orj',
