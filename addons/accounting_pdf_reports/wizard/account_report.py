...
class AccountingReport(models.TransientModel):
    ...
    date_fror_cmp = fields.Date(string='Date From')
    ...
    def _build_comparison_context(self, data):
        ...
        if data['form']['filter_cmp'] == 'filter_date':
            result['date_from'] = data['form']['date_fror_cmp']
    ...
    def check_report(self):
        ...
        data = {}
        data['form'] = self.read(['account_report_id', 'date_fror_cmp', 'date_to_cmp', 'journal_ids', 'filter_cmp', 'target_move'])[0]
    ...
    def _print_report(self, data):
        data['form'].update(self.read(['date_fror_cmp', 'debit_credit', 'date_to_cmp', 'filter_cmp', 'account_report_id', 'enable_filter', 'label_filter', 'target_move'])[0])
