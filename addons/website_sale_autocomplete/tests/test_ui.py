...
from orj.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from orj.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'orj.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
