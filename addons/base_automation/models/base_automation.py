...
from orj import _, api, exceptions, fields, models
from orj.http import request
from orj.tools import DEFAULT_SERVER_DATETIME_FORMAT, safe_eval
...
class BaseAutomation(models.Model):
    ...
    def _get_filter_domain_fields(self):
        ...
        # see: https://github.com/orj/orj/pull/189772#issuecomment-2548804283
