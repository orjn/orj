...
class TestUBLDK(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_export_invoice_two_line_partner_dk(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_orj/oioubl_out_invoice_partner_dk.xml")
    ...
    def test_export_invoice_two_line_foreign_partner_be(self):
        ...
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_orj/oioubl_out_invoice_foreign_partner_be.xml")

    @freeze_time('2017-01-01')
    def test_export_invoice_two_line_foreign_partner_fr(self):
        invoice = self.create_post_and_send_invoice(partner=self.partner_c)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_orj/oioubl_out_invoice_foreign_partner_fr.xml")
    ...
    def test_export_credit_note_two_line_partner_dk(self):
        ...
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_orj/oioubl_out_refund_partner_dk.xml")
    ...
    def test_export_credit_note_two_line_partner_fr(self):
        ...
        self.assertTrue(refund.ubl_cii_xml_id)
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_orj/oioubl_out_refund_foreign_partner_fr.xml")
