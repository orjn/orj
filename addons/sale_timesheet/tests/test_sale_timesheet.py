...
from orj.addons.hr_timesheet.tests.test_timesheet import TestCommonTimesheet
from orj.addons.sale_timesheet.tests.common import TestCommonSaleTimesheet
