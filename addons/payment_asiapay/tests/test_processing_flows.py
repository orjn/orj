...
from orj.addons.payment_asiapay.controllers.main import AsiaPayController
from orj.addons.payment_asiapay.tests.common import AsiaPayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):

    @mute_logger('orj.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'orj.addons.payment_asiapay.controllers.main.AsiaPayController.'
