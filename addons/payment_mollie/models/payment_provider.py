...
from orj import _, fields, models, service
from orj.exceptions import ValidationError

from orj.addons.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        orj_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Orj/{orj_version} MollieNativeOrj/{module_version}',
        }
