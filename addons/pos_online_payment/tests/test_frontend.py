...
from orj.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from orj.addons.mail.tests.common import mail_new_test_user
from orj.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from orj.addons.account.models.account_payment_method import AccountPaymentMethod
from orj.osv.expression import AND
from orj.addons.point_of_sale.tests.common import archive_products
...
class TestUi(TestPointOfSaleHttpCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('orj.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
