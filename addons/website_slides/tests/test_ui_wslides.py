...
from orj.fields import Command, Datetime
...
class TestUi(TestUICommon):
    ...
    @mute_logger("orj.http", "orj.addons.base.models.ir_rule", "werkzeug")
...
class TestUiPublisher(HttpCaseGamification):
    ...
    def fetch_proxy(self, url):
        if url.endswith('ThreeTimeAKCGoldWinnerPembrookeWelshCorgi.jpg'):
            ...
            with file_open('base/tests/orj.jpg', 'rb') as f:
                content = f.read()
