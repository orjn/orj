...
from orj.addons.l10n_in_edi_ewaybill.models.error_codes import ERROR_CODES
from orj.tools import _, LazyTranslate
...
class EWayBillError(Exception):
    ...
    def __init__(self, response):
        ...
        self.error_json.setdefault('orj_warning', [])
    ...
    def _ewaybill_make_transaction(self, operation_type, json_payload):
        ...
        try:
            ...
            if "no-credit" in e.error_codes:
                e.error_json['orj_warning'].append({
            ...
            if '238' in e.error_codes:
                ...
                # This happens when authenticate called from another orj instance with same credentials
                # (like. Demo/Test)
