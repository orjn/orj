...
import orj
from orj import fields, exceptions, Command
...
from orj.tools import DEFAULT_SERVER_DATETIME_FORMAT
from orj.addons.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = orj.addons.account.models.account_move.AccountMove.action_post
        old_create = orj.models.BaseModel.create
        ...
        post_patch = patch('orj.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('orj.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('orj.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('orj.fields.Date.context_today', _today),
            patch('orj.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Orj will create delivery instead of receipt.
