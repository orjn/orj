...
from orj.tools.float_utils import float_compare
from orj.addons.l10n_jo_edi.tests.jo_edi_common import JoEdiCommon
from orj.addons.l10n_jo_edi.models.account_edi_xml_ubl_21_jo import JO_MAX_DP
...
class TestJoEdiPrecision(JoEdiCommon):
    ...
    def _validate_jo_edi_numbers(self, xml_string):
        ...
        Moreover, reported totals have to equal (or at least be as close as possible) to totals stored in Orj.
        And since the JOD has precision of 3 decimal places, everything is stored in Orj approximated to 3 decimal places.
        -------------------------------------------------------------------------------
