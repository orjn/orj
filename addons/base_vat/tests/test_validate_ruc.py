...
from orj._monkeypatches.stdnum import new_get_soap_client
...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch('orj.addons.base_vat.models.res_partner.check_vies', type(self)._vies_check_func):
    ...
    def test_vat_eu(self):
        """ Foreign companies that trade with non-ores in the EU may have a VATIN starting with "EU" instead of
        a country code.
        """
