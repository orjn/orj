...
from orj.addons.account.tests.common import AccountTestInvoicingHttpCommon
...
class TestPosQris(AccountTestInvoicingHttpCommon):
    ...
    def test_tour_qris_payment_fail(self):
        ...
        self.main_pos_config.with_user(self.pos_user).open_ui()
        with patch('orj.addons.l10n_id.models.res_bank._l10n_id_make_qris_request', side_effect=_patched_make_qris_request):
    ...
    def test_only_call_api_call_once(self):
        ...
        self.main_pos_config.with_user(self.pos_user).open_ui()
        with patch('orj.addons.l10n_id.models.res_bank._l10n_id_make_qris_request', side_effect=_patched_make_qris_request) as patched:
