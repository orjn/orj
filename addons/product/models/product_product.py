...
from orj.tools import float_compare, format_list, groupby
from orj.tools.image import is_image_size_above
from orj.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('orj.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/orj/orj/pull/38303
