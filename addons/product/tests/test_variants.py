...
from orj.tests import tagged, TransactionCase, Form
from orj.tools import mute_logger

from orj.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariants(ProductVariantsCommon):
    ...
    def test_variants_pricelist_code(self):
        vendor = self.env['res.partner'].create({'name': 'Bidou', 'email': 'bidou@orj.net'})
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'orj.addons.product.models.product_product.ProductProduct._filter_to_unlink',
