...
from orj.addons.website.models.website import Website
import orj.tests
...
class TestWebsiteSession(HttpCaseWithUserDemo):
    ...
    def test_02_inactive_session_lang(self):
        ...
        current_website_id = self.env["website"]._get_current_website_id(orj.tests.HOST)
        self.env["website"].browse(current_website_id).domain = orj.tests.HOST
