...
from orj.addons.sale_management.tests.common import SaleManagementCommon
from orj.addons.sale_pdf_quote_builder.controllers.quotation_document import (
...
class TestPDFQuoteBuilder(BaseUsersCommon, SaleManagementCommon):
    ...
    def test_quotation_document_upload_no_template(self):
        ...
        if 'website' not in self.env:
            ...
            from orj.addons.website.tools import MockRequest  # noqa: PLC0415
    ...
    def _test_custom_content_kanban_like(self):
        ...
        self.start_tour(
            f'/orj/sales/{self.sale_order.id}',
