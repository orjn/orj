...
from orj.addons.payment_xendit.controllers.main import XenditController
from orj.addons.payment_xendit.models.payment_provider import PaymentProvider
from orj.addons.payment_xendit.tests.common import XenditCommon
...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_empty_rendering_values_if_direct(self):
        ...
        with patch(
            'orj.addons.payment_xendit.models.payment_provider.PaymentProvider'
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction('redirect')
        with patch(
            'orj.addons.payment_xendit.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('orj.addons.payment_xendit.controllers.main')
