...
from orj.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from orj.addons.test_mail.models.test_mail_models import MailTestSimple
from orj.addons.test_mail.tests.common import TestRecipients
from orj.api import call_kw
from orj.exceptions import AccessError
from orj.tests import tagged
from orj.tools import mute_logger, formataddr
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('orj.addons.mail.models.mail_mail', 'orj.models.unlink', 'orj.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. orjbot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Orj-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('orj.addons.mail.models.mail_mail', 'orj.tests')
    ...
    @users('employee')
    @mute_logger('orj.addons.mail.models.mail_mail', 'orj.addons.mail.models.mail_message_schedule', 'orj.models.unlink')
    ...
    @mute_logger('orj.addons.mail.models.mail_mail', 'orj.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('orj.addons.base.models.ir_model', 'orj.addons.mail.models.mail_mail')
