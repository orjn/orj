...
from orj import api, Command, fields, SUPERUSER_ID
from orj.addons.base.models.ir_mail_server import MailDeliveryException
from orj.addons.mail.tests.common import MailCommon
from orj.exceptions import AccessError
from orj.tests import common, tagged, users
...
class TestMailMail(MailCommon):
    ...
    def test_mail_mail_send_exceptions_origin(self):
        ...
        for default_from in [False, '']:
            ...
            self._reset_data()
            with self.mock_mail_gateway(), mute_logger('orj.addons.mail.models.mail_mail'):
...
class TestMailMailServer(MailCommon):
    ...
    @mute_logger('orj.addons.mail.models.mail_mail')
    @patch('orj.addons.base.models.ir_attachment.IrAttachment.file_size', new_callable=PropertyMock)
...
class TestMailMailRace(common.TransactionCase):
    ...
    def test_mail_bounce_during_send(self):
        ...
        def send_email(self, message, *args, **kwargs):
            with this.registry.cursor() as cr, mute_logger('orj.sql_db'):
                try:
