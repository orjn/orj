...
from orj.addons.mail.wizard.mail_compose_message import MailComposer
from orj.addons.test_mail.models.test_mail_models import MailTestTicket
from orj.addons.test_mail.tests.common import TestRecipients
from orj.fields import Datetime as FieldDatetime
from orj.exceptions import AccessError, UserError
from orj.tests import Form, tagged, users
from orj.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('orj.tests', 'orj.addons.mail.models.mail_mail', 'orj.models.unlink')
    ...
    @mute_logger('orj.tests', 'orj.addons.base.models.ir_rule', 'orj.addons.mail.models.mail_mail', 'orj.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('orj.models.unlink', 'orj.addons.mail.models.mail_mail', 'orj.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('orj.models.unlink', 'orj.addons.mail.models.mail_mail')
