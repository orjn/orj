...
from orj import fields, exceptions, tests
from orj.addons.mail.tests.common import mail_new_test_user, MailCommon
from orj.addons.test_mail.models.test_mail_models import MailTestActivity
from orj.tests import Form, HttpCase, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('orj.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('orj.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('orj.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
