...
from orj.tests import Form, users, warmup, tagged
...
class TestBaseAPIPerformance(BaseMailPerformance):
    ...
    def test_activity_full(self):
        ...
        with self.assertQueryCount(admin=6, employee=6):
            ...
            # read activity_type to normalize cache between ore and community
            # voip module read activity_type during create leading to one less query in ore on action_feedback
    ...
    def test_activity_mixin(self):
        ...
        with self.assertQueryCount(admin=5, employee=5):
            ...
            # read activity_type to normalize cache between ore and community
            # voip module read activity_type during create leading to one less query in ore on action_close
            _category = activity.activity_type_id.category
                            ...
                            "mail.message": self._filter_messages_fields(
                                {
                                    ...
                                    "email_from": '"OrjBot" <orjbot@example.com>',
                                    "id": message.id,
                                    "is_discussion": True,
                                    "is_note": False,
                                    "linkPreviews": [],
