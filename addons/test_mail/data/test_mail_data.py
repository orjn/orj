...
To: {to}
cc: {cc}
Received: by mail1.orj.net (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@orj.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
Received: by mail1.grosbedon.com (Postfix, from userid 10002)
    id E8166BFACA; Fri, 23 Aug 2013 13:18:01 +0200 (CEST)
From: "Bruce Wayne" <bruce@wayneores.com>
Content-Type: multipart/alternative;
...
From: "Bruce Wayne" <bruce@wayneores.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@orj.net>
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@orj.net>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.orj.net
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@orj.net header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@orj.net designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@orj.net;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=orj.net
Return-Path: <soup@orj.net>
Received: from mail2.orj.net (mail2.orj.net. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@orj.net designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.orj.net (Postfix) with ESMTPSA id 7B571A4085
	for <what@orj.net>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=orj.net; s=mail;
...
To: what@orj.net
From: Soup <soup@orj.net>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@orj.net>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.orj.net
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.orj.net">http://www.orj.net</a> </pre>
  </body>
</html>
...
Delivered-To: orj+82240-account.invoice-19177@mycompany.example.com
...
MIME-Version: 1.0
Message-Id: {msg_id}
references: <1571814481.189281940460205.799582441238467-orj-19177-account.invoice@mycompany.example.com>
Subject: Test
...
X-Orj-Objects: account.invoice-19177
...
In-Reply-To: <829228111124527.1111111602.256611118262939-orj-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-orj-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-orj-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-orj-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.orj.net">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
MIME-Version: 1.0
Message-Id: {extra}
references: <670034078674109.1555335454.587288856506348-orj-32-project.task@aaa>
Subject: Re: Test
...
X-Orj-Objects: project.project-3, ,project.task-32
...
Received: by mailserver.orj.net (Postfix)
...
MIME-Version: 1.0
Content-Type: multipart/report; report-type=delivery-status;
        boundary="DFFDC17AA03.1673346179/mailserver.orj.net"
Message-Id: <40230110102259.EA0B917B8E4@mailserver.orj.net>
Content-Transfer-Encoding: 7bit
Delivered-To: {delivered_to}
Return-Path: <>

--DFFDC17AA03.1673346179/mailserver.orj.net
Content-Description: Notification
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable
...
Reporting-MTA: dns; mailserver.orj.net
X-Postfix-Queue-ID: DFFDC17AA03
X-Postfix-Sender: rfc822; bounce@xxx.orj.net
...
Return-Path: <bounce@xxx.orj.net>
Received: from eupp00.orj.net (00.72.79.34.bc.googleusercontent.com [34.=
79.72.00])
        by mailserver.orj.net (Postfix) with ESMTPS id DFFDC17AA03;
        Tue, 10 Jan 2023 11:22:57 +0100 (CET)
DKIM-Signature: v=3D1; a=3Drsa-sha256; c=3Dsimple/simple; d=3Dxxx.be;
        s=3Dorj; t=3D1673346178;
...
Message-Id: <368396033905967.1673346177.695352554321289-orj-11-sale.o=
rder@eupp00>
references: <792105153140463.1673746527.352018594741821-orj-11-sale.o=
rder@xxx.orj.net> <368396033905967.1673346177.695352554321289-orj-11=
-sale.order@eupp00>
Subject: Thi is a SO (Ref SO/11)
From: info@xxx.orj.net
Reply-To: "SO/11" <catchall@xxx.orj.net=
>
To: "rdesfrdgtfdrfesd@outlook.com" <rdesfrdgtfdrfesd@outlook.com>
Date: Tue, 29 Feb 2023 06:09:06 -0000
X-Orj-Objects: sale.order-11
MIME-Version: 1.0
...
To: "Thai Orj User" <thai-user@orj.net>
