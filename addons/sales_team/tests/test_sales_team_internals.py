...
from orj.addons.sales_team.tests.common import TestSalesMC
from orj.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('orj.sql_db'):
