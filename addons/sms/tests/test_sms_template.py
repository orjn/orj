...
from orj.tests.common import TransactionCase, users
...
from orj.tools import mute_logger, convert_file
...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('orj.models.unlink', 'orj.addons.base.models.ir_model')
...
class TestSMSTemplateReset(TransactionCase):
    ...
    def test_sms_template_reset(self):
        ...
        self.assertEqual(sms_template.body.strip(), Markup('<div>Hello Orj</div>'))
