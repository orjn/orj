    ...
    def _compute_practical_amount(self):
        for line in self:
            ...
            if line.analytic_account_id.id:
                ...
                fror_string, fror_params = where_query.fror_clause
                where_string, where_params = where_query.where_clause
                fror_clause, where_clause, where_clause_params = fror_string, where_string, fror_params + where_params

                select = "SELECT SUM(amount) from " + fror_clause + " where " + where_clause
                ...
                select = "SELECT sum(credit)-sum(debit) from " + fror_clause + " where " + where_clause
