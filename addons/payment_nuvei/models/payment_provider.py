...
from orj.addons.payment_nuvei import const
...
class PaymentProvider(models.Model):
    ...
    def _nuvei_calculate_signature(self, data, incoming=True):
        ...
        :param bool incoming: If the signature must be generated for an incoming (Nuvei to Orj) or
                              outgoing (Orj to Nuvei) communication.
