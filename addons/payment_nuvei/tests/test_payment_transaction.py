...
from orj.addons.payment_nuvei.controllers.main import NuveiController
from orj.addons.payment_nuvei.tests.common import NuveiCommon
...
class TestPaymentTransaction(NuveiCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        ), patch('orj.addons.payment_nuvei.models.payment_transaction.uuid4', make_uuid):
