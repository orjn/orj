...
class GoogleCalendarService():
    ...
    def delete(self, event_id, token=None, timeout=TIMEOUT):
        ...
        # making the deletion be handled entirely on their side, and then we archive the events in Orj.
    ...
    def _google_authentication_url(self, from_url='http://www.orj.net'):
        state = {
