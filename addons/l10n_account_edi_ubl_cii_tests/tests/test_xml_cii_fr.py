...
class TestCIIFR(TestUBLCommon):
    ...
    def test_export_import_invoice(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_orj/facturx_out_invoice.xml',
        )
        facturx_filename = self.env['account.edi.xml.cii']._export_invoice_filename(invoice)
    ...
    def test_export_import_refund(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_orj/facturx_out_refund.xml'
        )
    ...
    def test_export_tax_included(self):
        ...
        self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_orj/facturx_out_invoice_tax_incl.xml'
        )
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/facturx_ecotaxes_case1.xml')
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/facturx_ecotaxes_case2.xml')
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/facturx_ecotaxes_case3.xml')
    ...
    def test_facturx_has_no_negative_lines(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/facturx_positive_discount_price_unit.xml')
