...
class TestUBLBE(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_export_import_invoice(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_orj/bis3_out_invoice.xml',
        )
    ...
    def test_export_import_refund(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_orj/bis3_out_refund.xml',
        )
        self.assertEqual(attachment.name[-12:], "ubl_bis3.xml")
    ...
    def test_sending_to_public_admin(self):
        ...
        check_attachment(invoice1, "from_orj/bis3_out_invoice_public_admin_1.xml")
        # Switch the partner's roles
        invoice2 = self._generate_move(self.partner_2, self.partner_1, **invoice_vals)
        check_attachment(invoice2, "from_orj/bis3_out_invoice_public_admin_2.xml")
    ...
    def test_rounding_price_unit(self):
        ...
        * Invoice line net amount shall be rounded to two decimals
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_out_invoice_rounding.xml')
    ...
    def test_inverting_negative_price_unit(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_out_invoice_negative_unit_price.xml')
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_ecotaxes_case1.xml')
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_ecotaxes_case2.xml')
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_ecotaxes_case3.xml')
    ...
    def test_export_with_fixed_taxes_case4(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_ecotaxes_case4.xml')
    ...
    def test_export_payment_terms(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_pay_term.xml')
    ...
    def test_export_payment_terms_fixed_tax(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_pay_term_ecotax.xml')
    ...
    def test_export_payment_terms_with_discount(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_pay_term_discount.xml')
    ...
    def test_export_with_changed_taxes(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_export_with_changed_taxes.xml')
    ...
    def test_export_tax_exempt(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_orj/bis3_out_invoice_tax_exempt.xml')
    ...
    def test_import_and_create_partner_ubl(self):
        ...
        self._update_invoice_from_file(
            ...
            subfolder='tests/test_files/from_orj',
