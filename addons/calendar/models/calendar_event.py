...
from orj.addons.calendar.models.calendar_attendee import Attendee
from orj.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from orj.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Orj'
