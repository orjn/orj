...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('orj.tests', 'orj.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_orj(self):
        # set notifications to "handle in Orj" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Orj" notification setting can
