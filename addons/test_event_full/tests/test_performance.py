...
from orj.addons.test_event_full.tests.common import TestEventFullCommon
from orj.addons.website.tests.test_performance import UtilPerf
...
class TestEventPerformance(EventPerformanceCase):
    ...
    def test_event_create_form_notype(self):
        ...
        has_social = 'social_menu' in self.env['event.event']  # otherwise view may crash in ore
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'orj.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'orj.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
