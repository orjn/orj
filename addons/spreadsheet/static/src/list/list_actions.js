...
import { astToFormula, helpers } from "@orj/o-spreadsheet";
...
/**
 * @param {import("@orj/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@orj/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").OrjGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "ORJ.LIST"
    );
};
