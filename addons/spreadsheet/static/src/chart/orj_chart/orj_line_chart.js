...
export class OrjLineChart extends OrjChart {
...
chartRegistry.add("orj_line", {
    match: (type) => type === "orj_line",
    createChart: (definition, sheetId, getters) => new OrjLineChart(definition, sheetId, getters),
    getChartRuntime: createOrjChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OrjLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OrjLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => OrjLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});
...
function createOrjChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Orj to keep consistency
