...
import { components } from "@orj/o-spreadsheet";
...
export class FilterValue extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            try {
                const orjDataProvider = this.props.model.config.custom.orjDataProvider;
                await getFields(orjDataProvider.serverData, this.filter.modelName);
                this.isValid = true;
            } catch (e) {
