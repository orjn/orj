...
export class GlobalFiltersUIPlugin extends OrjUIPlugin {
    ...
    constructor(config) {
        ...
        this.orjDataProvider = config.custom.orjDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.orjDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
