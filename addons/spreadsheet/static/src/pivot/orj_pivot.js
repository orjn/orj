...
import { NO_RECORD_AT_THIS_POSITION, OrjPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@orj/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { OrjPivotLoader } from "./orj_pivot_loader";
...
/**
 * @typedef {import("@orj/o-spreadsheet").FunctionResultObject} FunctionResultObject
 * @typedef {import("@orj/o-spreadsheet").PivotMeasure} PivotMeasure
 * @typedef {import("@orj/o-spreadsheet").PivotDomain} PivotDomain
 * @typedef {import("@orj/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@orj/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").OrjPivot<OrjPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").OrjFields} OrjFields
 * @typedef {import("@spreadsheet").OrjPivotCoreDefinition} OrjPivotCoreDefinition
 * @typedef {import("@spreadsheet").SortedColumn} SortedColumn
 * @typedef {import("@spreadsheet").OrjGetters} OrjGetters
 ...
 * @implements {IPivot}
 */
export class OrjPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {OrjPivotCoreDefinition} params.definition
     * @param {OrjGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"ORJ"} */
        this.type = "ORJ";

        /** @type {OrjPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {OrjPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {OrjPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {OrjGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new OrjPivotLoader(services.orjDataProvider, this._load.bind(this));

        /** @type {OrjFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {OrjDataProvider}*/
        this.orjDataProvider = services.orjDataProvider;
    ...
    /**
     * @param {OrjPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new OrjPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new OrjPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new OrjPivotModel(
            { _t },
            {
            ...
            {
                orm: this.orjDataProvider.orm,
                serverData: this.orjDataProvider.serverData,
    ...
    /**
     * @param {import("@orj/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
...
export class OrjPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {OrjPivotCoreDefinition} definition
     * @param {OrjFields} fields
     */
...
supportedPivotPositionalFormulaRegistry.add("ORJ", true);
