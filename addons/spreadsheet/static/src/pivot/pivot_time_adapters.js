...
import { registries, helpers, constants } from "@orj/o-spreadsheet";
...
function boundedOrjNumberDateAdapter(lower, upper) {
    return {
        normalizeServerValue(groupBy, field, readGroupResult) {
            return Number(readGroupResult[groupBy]);
        },
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(orjWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(orjMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(orjQuarterAdapter));

extendSpreadsheetAdapter("day", orjDayAdapter);
extendSpreadsheetAdapter("year", orjNumberDateAdapter);
extendSpreadsheetAdapter("day_of_month", boundedOrjNumberDateAdapter(1, 31));
extendSpreadsheetAdapter("day", orjDayAdapter);
extendSpreadsheetAdapter("iso_week_number", boundedOrjNumberDateAdapter(0, 54));
extendSpreadsheetAdapter("month_number", boundedOrjNumberDateAdapter(1, 12));
extendSpreadsheetAdapter("quarter_number", boundedOrjNumberDateAdapter(1, 4));
extendSpreadsheetAdapter("day_of_week", orjDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", orjHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", orjMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", orjSecondNumberAdapter);
