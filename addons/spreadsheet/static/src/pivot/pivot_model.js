...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@orj/o-spreadsheet";
...
/**
 * @typedef {import("@orj/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@orj/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class OrjPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").OrjEnv} env
     * @param {import("@spreadsheet").OrjPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").OrjGetters}
         */
    ...
    /**
     * Get the Orj domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@orj/o-spreadsheet").PivotDimension} dimension
