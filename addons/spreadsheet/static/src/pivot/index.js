...
import { PivotOrjCorePlugin } from "./plugins/pivot_orj_core_plugin";
...
coreTypes.add("UPDATE_ORJ_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_ORJ_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_ORJ_PIVOT_DOMAIN", identity);

export { PivotOrjCorePlugin, PivotUIGlobalFilterPlugin };
