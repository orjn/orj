...
import { CellErrorType, EvaluationError } from "@orj/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./orj_data_provider").OrjDataProvider} OrjDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {OrjDataProvider} param0.orjDataProvider
     */
    constructor({ orjDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.orjDataProvider.orm;
    }

    get serverData() {
        return this.orjDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.orjDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.orjDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").OrjFields>}
 */
