...
from orj import api, fields, models, _, tools
from orj.exceptions import ValidationError, MissingError

from orj.addons.spreadsheet.utils.validate_data import fields_in_spreadsheet, menus_xml_ids_in_spreadsheet
...
class SpreadsheetMixin(models.AbstractModel):
    ...
    def _empty_spreadsheet_data(self):
        ...
        locale = lang._orj_lang_to_spreadsheet_locale()
        return {
            "version": 1,
            "sheets": [
                {
