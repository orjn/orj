...
import { closestElement } from "@web_editor/js/editor/orj-editor/src/OrjEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.orjEditor.toolbar = this.toolbarEl;
        this.orjEditor.autohideToolbar = !!fold;
    ...
    async getSnippetsMenuClass() {
        ...
        const { MassMailingSnippetsMenu } = await orj.loader.modules.get('@mass_mailing/js/snippets.editor');
