...
from orj import api, fields, models, _, Command, tools, SUPERUSER_ID
from orj.http import request
from orj.exceptions import AccessError, ValidationError, UserError
from orj.tools import convert, SQL
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by Orj but you can change it "
