import { Component, useEffect, useState, whenReady } from "@orj/owl";
import { OrjLogo } from "@point_of_sale/app/generic_components/orj_logo/orj_logo";
...
export class CustomerDisplay extends Component {
    ...
    static components = { OrjLogo, OrderWidget, Orderline, MainComponentsContainer };
    static props = [];
