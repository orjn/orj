...
from orj.addons.website_mass_mailing.controllers.main import MassMailController
from orj.addons.website_sale.controllers.main import WebsiteSale as WebsiteSaleController
