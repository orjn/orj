...
class MockLinkTracker(common.BaseCase):
    ...
    def setUp(self):
        ...
        link_tracker_title_patch = patch('orj.addons.link_tracker.models.link_tracker.LinkTracker._get_title_from_url', wraps=_get_title_from_url)
