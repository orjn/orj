...
The Orj <a href="https://www.orj.net/app/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Orj's user interface is designed with productivity in mind.
...
accounting; Orj has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Orj supports multiple currencies, multiple users with different access rights,
