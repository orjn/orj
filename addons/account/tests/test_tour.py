...
@orj.tests.tagged('post_install_l10n', 'post_install', '-at_install')
class TestUi(AccountTestInvoicingHttpCommon):
    ...
    def test_01_account_tour(self):
        ...
        self.start_tour("/orj", 'account_tour', login="admin")
    ...
    def test_01_account_tax_groups_tour(self):
        ...
        self.start_tour("/orj", 'account_tax_group', login="admin")
