...
from orj.tools import DEFAULT_SERVER_DATETIME_FORMAT, mute_logger
...
from orj.tools import SQL, unique
...
class ResPartner(models.Model):
    ...
    def _increase_rank(self, field, n=1):
        if self.ids and field in ['customer_rank', 'supplier_rank']:
            try:
                with self.env.cr.savepoint(flush=False), mute_logger('orj.sql_db'):
