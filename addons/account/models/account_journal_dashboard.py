...
from orj import models, api, _, fields, Command, tools
from orj.exceptions import UserError
from orj.osv import expression
from orj.release import version
from orj.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from orj.tools.misc import formatLang, format_date as orj_format_date, get_lang
      ...
      LEFT JOIN mail_activity_type act_type ON activity.activity_type_id = act_type.id
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': orj_format_date(self.env, activity['date_deadline'])
            }
