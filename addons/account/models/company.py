...
from orj import fields, models, api, _, Command
from orj.exceptions import ValidationError, UserError, RedirectWarning
from orj.osv import expression
from orj.tools import date_utils, format_list, SQL
from orj.tools.mail import is_html_empty
from orj.tools.misc import format_date
from orj.addons.account.models.account_move import MAX_HASH_VERSION
from orj.addons.account.models.partner import _ref_company_registry
from orj.addons.base_vat.models.res_partner import _ref_vat
