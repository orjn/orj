...
from orj import api, fields, models, Command, _
from orj.exceptions import ValidationError, UserError, RedirectWarning
from orj.osv import expression
from orj.tools import frozendict, format_date, float_compare, format_list, Query
from orj.tools.sql import create_index, SQL
from orj.addons.web.controllers.utils import clean_action

from orj.addons.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_orj_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_orj_rate(aml, other_aml, counterpart_currency)
