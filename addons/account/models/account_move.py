...
from orj import api, fields, models, _, Command, SUPERUSER_ID, modules, tools
from orj.tools.sql import column_exists, create_column
from orj.addons.account.tools import format_structured_reference_iso
from orj.exceptions import UserError, ValidationError, AccessError, RedirectWarning
...
from orj.tools.mail import email_re, email_split, is_html_empty, generate_tracking_message_id
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'Orj will automatically create one invoice line with default values to match it.',
    )
    ...
    def _get_invoice_reference_orj_invoice(self):
        """ This computes the reference based on the Orj format.
    ...
    def _get_invoice_reference_orj_partner(self):
        """ This computes the reference based on the Orj format.
    ...
    def _get_fields_to_copy_recurring_entries(self, values):
        ...
        values.update({
            ...
            'invoice_user_id': self.invoice_user_id.id,  # otherwise user would be OrjBot
        })
