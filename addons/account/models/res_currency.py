...
from orj.tools import date_utils, SQL
...
class ResCurrency(models.Model):
    ...
    def _get_simple_currency_table(self, companies) -> SQL:
        """ Helper creating the currency table and returning its definition for basic cases of Orj reports needing to convert amounts using only the
