...
class TestPaymentTransaction(MercadoPagoCommon, PaymentHttpCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction(flow='redirect')
        with patch(
            'orj.addons.payment_mercado_pago.models.payment_transaction.PaymentTransaction'
    ...
    def test_processing_notification_data_confirms_transaction(self):
        ...
        tx = self._create_transaction(flow='redirect')
        with patch(
            'orj.addons.payment_mercado_pago.models.payment_provider.PaymentProvider'
    ...
    @mute_logger('orj.addons.payment_mercado_pago.models.payment_transaction')
