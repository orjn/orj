...
from orj.addons.l10n_tr_nilvera.lib.nilvera_client import _get_nilvera_client
        ...
        with _get_nilvera_client(self.env.company) as client:
            ...
            if response.status_code == 200:
                ...
                if self.env.company.vat == nilvera_registered_tax_number:
                    ...
                    self.env['bus.bus']._sendone(self.env.user.partner_id, 'simple_notification', {
                        'type': 'success',
                        'message': _("Nilvera connection successful but the tax number on Nilvera and Orj doesn't match. Check Nilvera."),
                    })
