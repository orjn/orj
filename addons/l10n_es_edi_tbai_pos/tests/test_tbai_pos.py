...
from orj.addons.l10n_es_edi_tbai.tests.common import TestEsEdiTbaiCommonGipuzkoa
from orj.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPosEdi(TestEsEdiTbaiCommonGipuzkoa, TestPointOfSaleCommon):
    ...
    def pay_pos_order(cls, pos_order):
        ...
        with patch(
            'orj.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_document.requests.Session.request',
