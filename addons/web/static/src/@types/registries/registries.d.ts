declare module "registries" {
    ...
    export type ActionsRegistryItemShape = (((env: OrjEnv, action: ActionDescription) => void) | typeof Component) & {
        displayName?: string;
        path?: string;
        target?: ActionMode;
    };
    ...
    export interface CogMenuRegistryItemShape {
        ...
        groupNumber: number;
        isDisplayed?: (env: OrjEnv) => boolean;
    }

    export type DialogsRegistryItemShape = typeof Component;

    export type EffectsRegistryItemShape = (env: OrjEnv, params: object) => ({ Component: typeof Component, props: object } | undefined);

    export type ErrorDialogsRegistryItemShape = typeof Component;

    export type ErrorHandlersRegistryItemShape = (env: OrjEnv, error: Error, originalError: Error) => boolean;
    ...
    export type IrActionsReportHandlers = (action: ActionRequest, options: ActionOptions, env: OrjEnv) => (void | boolean | Promise<void | boolean>);
