...
import { App, reactive } from "@orj/owl";
...
function setup(light, currentState) {
    env = orj.__WOWL_DEBUG__.root.env;
...
/**
 * Make sure the home menu is open (ore only)
 */
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Orj flavor: ${isOre ? "Ore" : "Community"}`);
