import { Component, markup } from "@orj/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.orj.net/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function orjAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Orj.net account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.orj.net/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("orj_account", orjAccountItem)
