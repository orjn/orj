...
import { queryFirst, queryOne, queryRect } from "@orj/hoot-dom";
import { animationFrame } from "@orj/hoot-mock";
import { Component, reactive, useRef, useState, xml } from "@orj/owl";
 ...
 *
 * @param {import("@orj/hoot-dom").Target} from
...
/**
 * @param {import("@orj/hoot-dom").Target} from
 * @param {import("@orj/hoot-dom").Target} to
 */
