/** @orj-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@orj/hoot";
import { hover, queryFirst } from "@orj/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@orj/hoot-mock";
import { Component, onPatched, xml } from "@orj/owl";
import {
    contains,
    mountWithCleanup,
    patchWithCleanup,
