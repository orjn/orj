import { destroy, expect, test } from "@orj/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@orj/hoot-dom";
import { animationFrame } from "@orj/hoot-mock";
import { Component, onMounted, useState, xml } from "@orj/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
