import { destroy, expect, getFixture, onError, test } from "@orj/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@orj/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@orj/hoot-mock";
import { Component, useRef, useState, xml } from "@orj/owl";
import {
    contains,
    getService,
    makeMockEnv,
