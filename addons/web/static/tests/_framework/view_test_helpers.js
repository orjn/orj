import { after, expect, getFixture } from "@orj/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@orj/hoot-dom";
import { animationFrame, Deferred, tick } from "@orj/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@orj/owl";
