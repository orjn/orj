import { after, afterEach } from "@orj/hoot";
import {
    check,
    clear,
    click,
...
import { advanceFrame, advanceTime, animationFrame } from "@orj/hoot-mock";
import { hasTouch } from "@web/core/browser/feature_detection";

/**
 * @typedef {import("@orj/hoot-dom").DragHelpers} DragHelpers
 * @typedef {import("@orj/hoot-dom").DragOptions} DragOptions
 * @typedef {import("@orj/hoot-dom").FillOptions} FillOptions
 * @typedef {import("@orj/hoot-dom").InputValue} InputValue
 * @typedef {import("@orj/hoot-dom").KeyStrokes} KeyStrokes
 * @typedef {import("@orj/hoot-dom").PointerOptions} PointerOptions
 * @typedef {import("@orj/hoot-dom").Position} Position
 * @typedef {import("@orj/hoot-dom").QueryOptions} QueryOptions
 * @typedef {import("@orj/hoot-dom").Target} Target
 *
 * @typedef {DragOptions & {
...
/**
 * @template T
 * @typedef {import("@orj/hoot-dom").MaybePromise<T>} MaybePromise
 */
