...
import { queryFirst, queryOne } from "@orj/hoot-dom";
...
/**
 * @typedef {import("@orj/owl").Component} Component
 *
 * @typedef {import("@web/env").OrjEnv} OrjEnv
 *
 * @typedef {Parameters<typeof import("@orj/owl").mount>[2]} MountOptions
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@orj/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
