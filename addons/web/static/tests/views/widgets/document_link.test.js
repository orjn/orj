...
test("documentation_link: absolute path (http)", async () => {
    await mountView({
        ...
        arch: /* xml */ `
            <form>
                <field name="bar"/>
                <widget name="documentation_link" path="http://www.orj.net/"/>
            </form>`,
    });
    expect(".o_doc_link").toHaveAttribute("href", "http://www.orj.net/");
});
...
test("documentation_link: absolute path (https)", async () => {
    await mountView({
        ...
        <form>
            <field name="bar"/>
            <widget name="documentation_link" path="https://www.orj.net/"/>
        </form>`,
    });

    expect(".o_doc_link").toHaveAttribute("href", "https://www.orj.net/");
});
