import { after, beforeEach, expect, test } from "@orj/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Deferred, advanceFrame, animationFrame, runAllTimers, tick } from "@orj/hoot-mock";
import { Component, onRendered, onWillRender, xml } from "@orj/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check orj/orj#61981 for more details.
