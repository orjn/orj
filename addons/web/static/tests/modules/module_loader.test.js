import { beforeEach, expect, getFixture, test } from "@orj/hoot";
import { microTick, tick } from "@orj/hoot-dom";
...
/** @type {typeof OrjModuleLoader} */
const ModuleLoader = Object.getPrototypeOf(orj.loader.constructor);
