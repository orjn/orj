...
import { animationFrame, Deferred, mockDate, runAllTimers, tick } from "@orj/hoot-mock";
import {
    defineActions,
    defineMenus,
    defineModels,
...
import { onWillStart, onWillUpdateProps } from "@orj/owl";
...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    const expectedRpcData = JSON.stringify({
        ...
        error: {
            ...
            code: 200,
            data: {
                name: "orj.exceptions.Programming error",
                debug: "traceback",
                arguments: [],
                context: {},
            },
            exceptionName: "orj.exceptions.Programming error",
            subType: "server",
            message: "This is a server Error, it should be displayed in an error dialog",
            id: null,
            model: "foo",
