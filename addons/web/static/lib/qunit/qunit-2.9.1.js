...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("OrjBeforeTestHook", "OrjAfterTestHook"); // Orj customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("OrjBeforeTestHook"); // Orj customization
