...
class BasePreferences {
  ...
  #defaults = Object.freeze({
    ...
    // Orj: don't support scripting (#115302)
    enableScripting: false,
    // Orj: disable stamp editor
    enableStampEditor: false,
    // Orj: open links in new tabs to keep orj document (#84594)
  ...
  try {
    ...
    activeService.renderPages().then(function () {
      ...
      if (activeServiceOnEntry.active) {
        // ORJ Patch: https://github.com/mozilla/pdf.js/issues/10630#issuecomment-855754913
