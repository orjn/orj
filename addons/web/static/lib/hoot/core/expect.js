 ...
 *
 * @typedef {import("@orj/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@orj/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@orj/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@orj/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/orj/i);
     */
