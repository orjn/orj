...
/**
 * @typedef {Parameters<typeof import("@orj/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@orj/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@orj/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@orj/owl").Component} target
 */
