...
from orj.addons.base.models.ir_qweb_fields import nl2br
from orj.tools import html2plaintext, is_html_empty, image as tools
...
class BaseDocumentLayout(models.TransientModel):
    ...
    def _compile_scss(self, scss_source):
        ...
        Parameters are the same from orj/addons/base/models/assetsbundle.py
