...
from orj.http import request, DEFAULT_MAX_CONTENT_LENGTH
from orj.tools import ormcache, config
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = orj.service.common.exp_version()
        ...
        mods = orj.conf.server_wide_modules or []
        if request.db:
        ...
        session_info = {
            ...
            "support_url": "https://www.orj.net/buy",
            "name": user.name,
            "username": user.login,
