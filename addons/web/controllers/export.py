...
from orj.http import content_disposition, request
from orj.tools import lazy_property, osutil
from orj.tools.misc import xlsxwriter
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from Orj's export data to whatever the
