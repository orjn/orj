...
from orj.tools import float_compare, float_is_zero
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~orj.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~orj.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
