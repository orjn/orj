...
from orj.tools.float_utils import float_compare, float_is_zero, float_round
from orj.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision of your unit of measure.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=orjbot_id, subject=msg_subject)
