...
from orj.tools import float_compare, float_is_zero, frozendict, split_every, format_date
...
class StockWarehouseOrderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity specified for this field, Orj generates "
    ...
    product_max_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity, Orj generates "
