...
class TestItAccountMoveSend(TestItEdi, TestAccountMoveSendCommon):
    ...
    def test_invoice_multi_without_l10n_it_edi_xml_export(self):
        ...
        with patch(
                'orj.addons.account.models.account_move_send.AccountMoveSend._get_default_extra_edis',
    ...
    def test_invoice_send_with_multiple_company(self):
        ...
        with patch('orj.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload', return_value={}, autospec=True) as mock_check:
