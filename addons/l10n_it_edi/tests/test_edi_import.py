...
from orj import fields, sql_db, tools, Command
from orj.tests import new_test_user, tagged
from orj.addons.l10n_it_edi.tests.common import TestItEdi
...
class TestItEdiImport(TestItEdi):
    ...
    def test_receive_invalid_xml(self):
        ...
        with tools.mute_logger("orj.addons.l10n_it_edi.models.ir_attachment"):
    ...
    def test_receive_same_vendor_bill_twice(self):
        ...
        with (patch.object(proxy_user.__class__, '_decrypt_data', return_value=self.fake_test_content),
              patch.object(sql_db.Cursor, "commit", mock_commit),
              tools.mute_logger("orj.addons.l10n_it_edi.models.account_move")):
