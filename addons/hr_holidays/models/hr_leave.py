...
from orj import api, Command, fields, models, tools
from orj.addons.base.models.res_partner import _tz_get
from orj.addons.resource.models.utils import float_to_time, HOURS_PER_DAY
from orj.exceptions import AccessError, UserError, ValidationError
from orj.tools.float_utils import float_round, float_compare
from orj.tools.misc import format_date
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from OrjBot (sudo)
