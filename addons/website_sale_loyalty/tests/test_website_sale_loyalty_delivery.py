...
from orj.addons.base.tests.common import DISABLED_MAIL_CONTEXT
from orj.addons.website.tools import MockRequest
from orj.addons.website_sale.tests.common import WebsiteSaleCommon
from orj.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
