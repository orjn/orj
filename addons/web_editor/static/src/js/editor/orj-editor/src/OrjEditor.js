...
export class OrjEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as orj-editor utils to avoid this
        ...
        this.editable.classList.add("orj-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const orjHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const orjText = selection.toString().replace(/\uFEFF/g, "").replace(/\u00A0/g, " ");
        clipboardEvent.clipboardData.setData('text/plain', orjText);
        clipboardEvent.clipboardData.setData('text/html', orjHtml);
        clipboardEvent.clipboardData.setData('text/orj-editor', orjHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('orj-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const orjEditorHtml = ev.clipboardData.getData('text/orj-editor');
        ...
        } else if (orjEditorHtml) {
            const fragment = parseHTML(this.document, orjEditorHtml);
