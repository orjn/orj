...
import { OrjEditor } from '../src/OrjEditor.js';
...
export async function testEditor(Editor = OrjEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteOrjEditorHtml = async (editor, html) => pasteData(editor, html, 'text/orj-editor');
...
export class BasicEditor extends OrjEditor {}
