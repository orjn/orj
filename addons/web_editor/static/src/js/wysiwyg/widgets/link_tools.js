...
import { isButton } from "@web_editor/js/editor/orj-editor/src/OrjEditor";
...
export class LinkTools extends Link {
    ...
    applyLinkToDom() {
        ...
        this.props.wysiwyg.orjEditor.historyStep();
    ...
    _onColorpaletteColorPicked(cssProperty, params) {
        ...
        this.props.wysiwyg.orjEditor.execCommand('applyColor', '', 'color');
        this.props.wysiwyg.orjEditor.execCommand('applyColor', '', 'backgroundColor');
    ...
    __onURLInput() {
        ...
        this.props.wysiwyg.orjEditor.historyPauseSteps('_onURLInput');
        this._checkDocumentState();
        this._syncContent();
        this._adaptPreview();
        this.props.wysiwyg.orjEditor.historyUnpauseSteps('_onURLInput');
    }
    /**
