...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.orjEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.orjEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        const editable = this.wysiwyg.orjEditor.editable;
        this.$target.popover({
            html: true,
            content: this.$el,
            placement: 'bottom',
        ...
        if (document !== this.wysiwyg.orjEditor.document) {
            $(this.wysiwyg.orjEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.orjEditor.document).off('.link_popover');
