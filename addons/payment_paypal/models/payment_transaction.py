...
from orj.addons.payment_paypal import utils as paypal_utils
from orj.addons.payment_paypal.const import PAYMENT_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    # this field has no use in Orj except for debugging
