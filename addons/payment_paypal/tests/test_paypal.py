...
from orj.addons.payment_paypal.controllers.main import PaypalController
from orj.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with patch(
            'orj.addons.payment_paypal.models.payment_provider.PaymentProvider'
    ...
    @mute_logger('orj.addons.payment_paypal.controllers.main')
    ...
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'orj.addons.payment_paypal.controllers.main.PaypalController'
