...
from orj.addons.l10n_in_edi.tests.test_edi_json import TestEdiJson
from orj.addons.l10n_in_edi_ewaybill.models.account_edi_format import AccountEdiFormat
