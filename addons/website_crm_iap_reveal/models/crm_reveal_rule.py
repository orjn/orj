...
from orj.addons.crm.models import crm_stage
from orj.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.orj.net'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. Orj will not create lead if no match')
    ...
    def _create_lead_from_response(self, result):
        ...
        template_values.update({
            'flavor_text': _("Opportunity created by Orj Lead Generation"),
    ...
    # Methods responsible for format response data in to valid orj lead data
