...
from orj.tools import float_round, float_repr, date_utils, SQL
from orj.tools.xml_utils import cleanup_xml_node, find_xml_value
from orj.addons.l10n_es_edi_facturae.xml_utils import (
    NS_MAP,
    _canonicalize_node,
    _reference_digests,
)
...
class AccountMove(models.Model):
    ...
    def _search_product_for_import(self, item_description):
        # Exported Orj XML will have item_description = "[default_code] name".
