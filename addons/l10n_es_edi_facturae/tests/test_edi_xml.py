...
@patch('orj.addons.certificate.models.certificate.Certificate._compute_is_valid', _compute_is_valid)
class TestEdiFacturaeXmls(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.certificate_module = "orj.addons.certificate.models.certificate"
        cls.move_module = "orj.addons.l10n_es_edi_facturae.models.account_move"
