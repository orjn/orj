...
export class CredentialDialog extends Component {
    ...
    async connectToServer() {
        try {
            if (!this.form.db_uuid || !this.form.ore_code) {
                return;
            }
            ...
            <t t-set-slot="body">
                ...
                <div class="mt-3">
                    ...
                    <div class="input-group-sm mb-3">
                        ...
                        <input name="token" type="text" class="form-control" t-model="this.form.ore_code" />
                        <small t-if="!this.form.ore_code" class="text-danger">Please enter a contract number</small>
                    </div>
