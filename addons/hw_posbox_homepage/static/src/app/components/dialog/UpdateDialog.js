...
export class UpdateDialog extends Component {
    ...
    async getVersionInfo() {
        ...
        try {
            ...
            this.state.orjIsUpToDate = data.orjIsUpToDate;
    ...
    get everythingIsUpToDate() {
        return this.state.orjIsUpToDate && this.state.imageIsUpToDate;
    }
    ...
    static template = xml`
        ...
        <BootstrapDialog identifier="'update-configuration'" btnName="'Update'" onOpen.bind="getVersionInfo" onClose.bind="onClose">
            <t t-set-slot="header">
                <div>
                    Update
                    <a href="https://www.orj.net/documentation/18.0/applications/general/iot/config/updating_iot.html" class="fa fa-question-circle text-decoration-none text-dark" target="_blank"></a>
                </div>
            </t>
            <t t-set-slot="body">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-else="" class="alert alert-warning small mb-0">
                        ...
                        <a href="https://www.orj.net/documentation/18.0/applications/general/iot/config/updating_iot.html#flashing-the-sd-card-on-iot-box" target="_blank" class="alert-link">
                            Flashing the SD Card on IoT Box
                        </a>
                    </div>
                    <div t-if="this.store.dev" class="alert alert-light small">
                        <a href="https://nightly.orj.net/master/iotbox/" target="_blank" class="alert-link">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-if="this.state.orjIsUpToDate" class="text-success px-2 small">
                    ...
                    <div t-if="this.store.dev" class="alert alert-light small">
                        Current: 
                        <a t-att-href="'https://github.com/orj/orj.netmit/' + this.state.currentCommitHash" target="_blank" class="alert-link">
