...
import * as hoot from "@orj/hoot-dom";
import { pick } from "@web/core/utils/objects";

/**
 * @typedef TourStep
 * @property {"ore"|"community"|"mobile"|"desktop"|HootSelector[][]} isActive Active the step following {@link isActiveStep} filter
 * @property {string} [id]
...
export class TourStep {
    ...
    get active() {
        ...
        const standardKeyWords = ["ore", "community", "mobile", "desktop", "auto", "manual"];
        ...
        const edition =
            (session.server_version_info || "").at(-1) === "e" ? "ore" : "community";
        const checkEdition =
            isActiveArray.includes(edition) ||
            (!isActiveArray.includes("ore") && !isActiveArray.includes("community"));
