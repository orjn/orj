...
import { click, edit, keyDown, keyUp, press, queryOne } from "@orj/hoot-dom";
...
test("Click on element with unique orj class", async () => {
...
test("Click on element with no unique orj class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest orj class", async () => {
