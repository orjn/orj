...
import { expect, getFixture } from "@orj/hoot";
import { queryOne } from "@orj/hoot-dom";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.orj-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("orj-editor-editable");
