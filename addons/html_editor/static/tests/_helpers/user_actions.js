...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@orj/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteOrjEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.orj.orj-editor");
}
/**
 * @param {Node} node
 */
