...
import { click, hover, queryAll, queryOne, waitFor, waitForNone } from "@orj/hoot-dom";
...
test("Toolbar should not overflow scroll container", async () => {
    ...
    const editable = queryOne(".orj-editor-editable");
...
test("Table column control should always be displayed on top of the table", async () => {
    ...
    const scrollableElement = queryOne(".o_content");
    const table = queryOne(".orj-editor-editable table");
    await hover(".orj-editor-editable td");
