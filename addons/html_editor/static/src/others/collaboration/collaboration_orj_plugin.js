...
/**
 * @typedef { Object } CollaborationOrjShared
 * @property { CollaborationOrjPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationOrjPlugin extends Plugin {
    static id = "collaborationOrj";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.orjEditor.multiselectionRemove(fromPeerId);
                        break;
