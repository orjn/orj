...
import orj
from orj import api, modules
from .models.bus import dispatch
from orj.http import root, Request, Response, SessionExpiredException, get_default_session
from orj.modules.registry import Registry
from orj.service import model as service_model
from orj.service.server import CommonServer
from orj.service.security import check_session
from orj.tools import config, lazy_property
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if orj.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('ORJ_BUS_PUBLIC_SAMESITE_WS'):
            return
