...
from ..models.bus import json_dump, get_notify_payloads, NOTIFY_PAYLOAD_MAX_LENGTH, ORJ_NOTIFY_FUNCTION
...
class NotifyTests(TransactionCase):
    ...
    def test_postcommit(self):
        ...
        if ORJ_NOTIFY_FUNCTION != 'pg_notify':
            return
        channels = []
