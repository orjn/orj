/** @orj-module alias=@bus/../tests/helpers/model_definitions_setup default=false */
...
insertRecords("res.users", [
    {
        ...
        display_name: "OrjBot",
        login: "__system__",
        id: TEST_USER_IDS.orjbotUserId,
        name: "Public user",
        partner_id: TEST_USER_IDS.orjbotId,
    },
    {
