import { after, expect, registerDebugInfo } from "@orj/hoot";
import { Deferred } from "@orj/hoot-mock";
import {
    MockServer,
    defineModels,
    mockService,
...
import { on } from "@orj/hoot-dom";
import { registry } from "@web/core/registry";
import { patch } from "@web/core/utils/patch";

/**
 * @typedef {[
 *  env: import("@web/env").OrjEnv,
...
/** @type {Record<string, (env: OrjEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<OrjEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: OrjEnv, id: string, payload: any) => any} handler
 */
