...
from orj.addons.base.tests.common import BaseUsersCommon
from orj.addons.product.tests.common import ProductAttributesCommon
from orj.addons.website.tools import MockRequest
from orj.addons.website_sale.controllers.combo_configurator import (
    WebsiteSaleComboConfiguratorController,
)
from orj.addons.website_sale.controllers.main import WebsiteSale
from orj.addons.website_sale.controllers.payment import PaymentPortal
from orj.addons.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(BaseUsersCommon, ProductAttributesCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (MockRequest(self.product.with_user(portal_user).env, website=website), patch(
            'orj.addons.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
