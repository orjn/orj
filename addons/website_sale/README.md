...
Orj is an <a href="https://www.orj.net/app/ecommerce">Open Source eCommerce</a>
...
Orj's unique *'edit inline'* and building blocks approach makes product pages
...
Orj's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Orj's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Orj marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Orj proposes
...
SEO tools are ready to use, with no configuration required. Orj suggests
...
Create new landing pages easily with the Orj inline editing feature. Send
...
Benefit from the power of Orj, in your online store: a powerfull tax engine,
...
Everything is integrated with Orj. No pain, real time.
