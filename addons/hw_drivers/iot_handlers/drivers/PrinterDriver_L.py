...
from orj.addons.hw_drivers.iot_handlers.interfaces.PrinterInterface_L import PPDs, conn, cups_lock
from orj.addons.hw_drivers.main import iot_devices
from orj.addons.hw_drivers.tools import helpers
from orj.addons.hw_drivers.websocket_client import send_to_controller
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Orj instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
