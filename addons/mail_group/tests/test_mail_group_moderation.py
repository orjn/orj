...
from orj.addons.mail_group.tests.data import GROUP_TEMPLATE
from orj.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('orj.models.unlink', 'orj.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('orj.addons.base.models.ir_rule', 'orj.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('orj.addons.mail.models.mail_thread', 'orj.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('orj.addons.mail.models.mail_thread', 'orj.addons.mail_group.models.mail_group_message', 'orj.models.unlink')
    @users('employee')
    ...
    @mute_logger('orj.addons.mail_group.models.mail_group')
    @users('employee')
