...
from orj.addons.payment_adyen import utils as adyen_utils
from orj.addons.payment_adyen.controllers.main import AdyenController
from orj.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('orj.addons.payment.models.payment_transaction'), \
            patch(
                'orj.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'orj.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('orj.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'orj.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    @mute_logger('orj.addons.payment_adyen.controllers.main')
    @mute_logger('orj.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'orj.addons.payment_adyen.controllers.main.AdyenController'
