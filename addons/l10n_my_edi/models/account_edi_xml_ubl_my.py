...
from orj.addons.account_edi_ubl_cii.models.account_edi_xml_ubl_20 import UBL_NAMESPACES
...
class AccountEdiXmlUBLMyInvoisMY(models.AbstractModel):
    ...
    * MyInvois API formats doc: https://sdk.myinvois.hasil.gov.my/documents
    ...
    def _get_partner_address_vals(self, partner):
        ...
        # In Orj, we mostly use these (although there is no standard format) so we'll try to use what Orj gives us.
