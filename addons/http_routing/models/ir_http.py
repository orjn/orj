...
import orj
from orj import api, models, exceptions, tools, http
from orj.addons.base.models import ir_http
from orj.addons.base.models.ir_http import RequestUID
from orj.addons.base.models.ir_qweb import keep_query, QWebException
from orj.addons.base.models.res_lang import LangData
from orj.exceptions import AccessError, MissingError
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except orj.exceptions.MissingError:
