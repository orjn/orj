...
from orj.addons.account.models.company import PEPPOL_DEFAULT_COUNTRIES
...
class ResPartner(models.Model):
    ...
    def _get_ubl_cii_formats_info(self):
        return {
            ...
            'ubl_a_nz': {'countries': ['NZ', 'AU'], 'on_peppol': False},  # Not yet available through Orj's Access Point, although it's a Peppol valid format
