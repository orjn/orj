...
from orj.tools import html2plaintext, cleanup_xml_node
...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_invoice_payment_terms_vals_list(self, invoice):
        ...
        if payment_term:
            # The payment term's note is automatically embedded in a <p> tag in Orj
    ...
    def _get_invoice_line_allowance_vals_list(self, line, tax_values_list=None):
        ...
        Note that allowance charges do not exist for credit notes in UBL 2.0, so if we apply discount in Orj
        ...
        allowance_vals = {
            ...
            # A reason should be provided. In Orj, we only manage discounts.
    ...
    def _get_invoice_line_vals(self, line, line_id, taxes_vals):
        ...
        period_vals = {}
        # deferred_start_date & deferred_end_date are ore-only fields
    ...
    def _export_invoice_vals(self, invoice):
        ...
        # Fixed taxes are not supposed to be taxes in real live. However, this is the way in Orj to manage recupel
