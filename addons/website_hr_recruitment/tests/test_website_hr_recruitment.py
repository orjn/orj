...
from orj.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@orj.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(orj.tests.HttpCase):
    def test_tour(self):
        ...
        with orj.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
