...
from orj.addons.payment_buckaroo.controllers.main import BuckarooController
from orj.addons.payment_buckaroo.tests.common import BuckarooCommon
...
class BuckarooTest(BuckarooCommon, PaymentHttpCommon):
    ...
    @mute_logger('orj.addons.payment_buckaroo.models.payment_transaction')
    ...
    @mute_logger('orj.addons.payment_buckaroo.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(BuckarooController._webhook_url)
        with patch(
            'orj.addons.payment_buckaroo.controllers.main.BuckarooController'
