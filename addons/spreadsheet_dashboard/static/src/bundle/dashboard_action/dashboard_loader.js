...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency) {
        const orjDataProvider = new OrjDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, orjDataProvider },
                mode: "dashboard",
        ...
        orjDataProvider.addEventListener("data-source-updated", () =>
