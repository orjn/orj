...
from orj import exceptions, Command, fields
from orj.tests import Form
from orj.addons.mrp.tests.common import TestMrpCommon
from orj.tests.common import HttpCase, tagged, freeze_time
from orj.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see orj/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/orj/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/orj/action-mrp.mrp_bom_form_action'
