...
export class WorkcenterDashboardGraphField extends JournalDashboardGraphField{
    getBarChartConfig() {
        ...
        const color19 = getColor(1, cookie.get("color_scheme"), "orj");
        const color13 = getColor(2, cookie.get("color_scheme"), "orj");
        const color10 = getColor(3, cookie.get("color_scheme"), "orj");
