...
from orj.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
...
class TestWebsiteEventBoothSale(HttpCaseWithUserPortal, TestWebsiteEventSaleCommon):
    ...
    def test_booth_pricelists_different_currencies(self):
        ...
        self.start_tour("/orj", 'event_booth_sale_pricelists_different_currencies', login='admin')
