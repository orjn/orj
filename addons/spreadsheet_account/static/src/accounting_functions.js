...
import { EvaluationError } from "@orj/o-spreadsheet";
...
const ORJ_PARTNER_BALANCE_ARGS = () => {
    const partner_arg = arg("partner_ids (string)", _t("The partner ids (separated by a comma)."));
    return [partner_arg, ...ORJ_RESIDUAL_ARGS()];
}

functionRegistry.add("ORJ.CREDIT", {
...
functionRegistry.add("ORJ.DEBIT", {
...
functionRegistry.add("ORJ.BALANCE", {
...
functionRegistry.add("ORJ.FISCALYEAR.START", {
...
functionRegistry.add("ORJ.FISCALYEAR.END", {
...
functionRegistry.add("ORJ.ACCOUNT.GROUP", {
