...
featurePluginRegistry.add("orjAccountingAggregates", AccountingPlugin);
...
cellMenuRegistry.add("move_lines_see_records", {
    ...
    async execute(env) {
        ...
        if ( func.functionName === "ORJ.PARTNER.BALANCE" ) {
        ...
        if ( date_range?.value && !isEvaluationError(date_range.value) ) {
            ...
            if ( ["ORJ.PARTNER.BALANCE", "ORJ.RESIDUAL"].includes(func.functionName) ) {
