...
from orj.addons.web_editor.controllers.main import Web_Editor
from orj.fields import Command


@orj.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(orj.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/orj/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@orj.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@orj.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(orj.tests.HttpCase):
...
class TestUi(orj.tests.HttpCase):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/orj", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/orj', 'conditional_visibility_2', login='admin')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/orj", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/orj', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/orj', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Orj',
            'social_facebook': 'https://www.facebook.com/Orj',
            'social_linkedin': 'https://www.linkedin.com/company/orj',
            'social_youtube': 'https://www.youtube.com/user/Orjonline',
            'social_github': 'https://github.com/orj',
            'social_instagram': 'https://www.instagram.com/explore/tags/orj/',
            'social_tiktok': 'https://www.tiktok.com/@orj',
        })
        self.start_tour("/", 'website_media_dialog_icons', login='admin')

    def test_27_website_clicks(self):
        self.start_tour('/orj', 'website_click_tour', login='admin')
