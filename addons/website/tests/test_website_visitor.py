...
from orj.addons.website.models.website_visitor import WebsiteVisitor
from orj.tests import common, tagged, HttpCase
...
class WebsiteVisitorTests(WebsiteVisitorTestsCommon):
    ...
    def test_merge_partner_with_visitor_single(self):
        """ The partner merge feature of Orj is auto discovering relations to
