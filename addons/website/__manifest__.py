...

{
    ...
    'sequence': 20,
    'summary': 'Ore website builder',
    'website': 'https://www.orj.net/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_orj_menu.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoomorj/zoomorj.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoomorj/zoomorj.js',
        ...
        'website.assets_wysiwyg': [
            ...
            'website/static/src/js/editor/orj_editor.js',
        ],
