...
import { onWillStart, status, useEffect } from '@orj/owl';
...
patch(LinkTools.prototype, {
    ...
    _isAbsoluteURLInCurrentDomain(url) {
        ...
        // Make sure that while being on abc.orj.net, if you edit a link and
        // enter an absolute URL using your real domain, it is still considered
        // to be added as relative, preferably.
        // In the past, you could not edit your website from abc.orj.net if you
