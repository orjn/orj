...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/orj-editor/src/utils/sanitize";
 ...
 */
HTMLElement.prototype.oDeleteBackwardOrjEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardOrjEditor(...arguments);
};
