 ...
 * corner to provide the authenticated user an access to his orj backend.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window.frameElement) {
        ...
        // - Having an event that's fire only when the page is from Orj avoids
        //   weird behaviours. (e.g. if we want to clear out the iframe, it might
        //   fire an DOMContentLoaded on a non orj page)
        window.frameElement.dispatchEvent(new CustomEvent('OrjFrameContentLoaded'));
    }
});
