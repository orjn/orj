...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/orj-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL orj.net",
    ...
    clickOnImgStep,
    {
        ...
        trigger: ':iframe #wrap .s_text_image a[href="http://orj.net"]:contains("orj.net")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http://orj.net") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to orj:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http://orj.net"]:contains("orj.net")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to orj website_2",
        trigger: '#o_link_dialog_label_input:value(orj.net)',
        run: 'edit orj website_2',
    },
    {
        content: "Change content (editing the DOM) to orj website",
        trigger: ':iframe .s_text_image a[href="http://orj.net"]:contains("orj website_2")',
        run: 'editor orj website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http://orj.net"]:contains("orj website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(orj website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be orj website and url orj.be",
        trigger: ':iframe .s_text_image a[href="http://orj.be"]:contains("orj website")',
        run: "click",
    },
    {
        content: "The new link content should be orj website and url orj.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://orj.be"]:contains("orj website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit orj.net && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http://orj.net")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.orj.net",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.orj.net']:has(img):has(h4):has(span)",
    },
    ...
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains(orj.net)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://orj.net']:contains('orj.net')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http://orj.net']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://orj.net")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https://orj.net in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https://orj.net";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https://orj.net']:contains('orj.net')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://orj.net")
            this.anchor.value = "http://orj.net";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/orj/orj.netmit/9fc283b514d420fdfd66123845d9ec3563572692
