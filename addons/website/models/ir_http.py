...
from orj.osv.expression import FALSE_DOMAIN
from orj.addons.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from orj.addons.http_routing.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(orj.conf.server_wide_modules)
