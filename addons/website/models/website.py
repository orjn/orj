...
from orj import api, fields, models, tools, release
from orj.addons.website.models.ir_http import sitemap_qs2dom
from orj.addons.website.tools import similarity_score, text_from_html, get_base_domain
from orj.addons.portal.controllers.portal import pager
from orj.addons.iap.tools import iap_tools
from orj.exceptions import AccessError, UserError, ValidationError
from orj.http import request
from orj.modules.module import get_manifest
from orj.osv.expression import AND, OR, FALSE_DOMAIN
from orj.tools import SQL, Query, sql as sqltools
from orj.tools.translate import _, xml_translate
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.orj.net'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.orj.net'
...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/orj/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Orj framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False):
        ...
        return "/orj/action-website.website_preview?" + urls.url_encode(action_params)
