...
from orj.tests import tagged, get_db_name, new_test_user, HttpCase
...
class TestTOTP(TestTOTPMixin, HttpCase):
    ...
    def test_totp(self):
        # 1. Enable 2FA
        self.start_tour('/orj', 'totp_tour_setup', login='test_user')
        ...
        with self.assertRaisesRegex(Fault, r'Access Denied'), mute_logger('orj.http'):
    ...
    def test_totp_administration(self):
        ...
        self.start_tour('/orj', 'totp_admin_disables', login='admin')
        self.start_tour('/', 'totp_login_disabled', login=None)
