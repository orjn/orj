...
from orj.addons.mail.tests.common import MockEmail
from orj.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger('orj.addons.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'orj.addons.event.models.event_mail',
        'orj.addons.event.models.event_mail_registration',
        'orj.addons.event.models.event_registration',
    )
