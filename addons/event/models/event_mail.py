...
from orj.tools import exception_to_unicode
from orj.tools.translate import _
from orj.exceptions import MissingError
...
class EventMailScheduler(models.Model):
    ...
    configuration allowing to send emails on events since Orj 9. A cron exists
