...
from orj import _, api, Command, fields, models, tools
...
from orj.tools import format_date, format_datetime, format_time, frozendict
from orj.tools.mail import is_html_empty, html_to_inner_content
from orj.tools.misc import formatLang
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/orj/registration-desk"
    ...
    def _get_printing_sponsor_text(self):
        ...
        return sponsor_text or "Powered by Orj"
