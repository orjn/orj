...
from orj.exceptions import UserError, ValidationError, RedirectWarning
from orj.tests import tagged
from orj.addons.account.tests.common import AccountTestInvoicingCommon
from orj.addons.l10n_id_efaktur.models.account_move import AccountMove
from orj.addons.l10n_id_efaktur.models.efaktur_document import FK_HEAD_LIST, LT_HEAD_LIST, OF_HEAD_LIST, _csv_row
from orj.exceptions import RedirectWarning
...
class TestIndonesianEfaktur(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        patch_kode_transaksi = patch('orj.addons.l10n_id_efaktur_coretax.models.account_move.AccountMove._compute_need_kode_transaksi',
                                AccountMove._compute_need_kode_transaksi)
        cls.startClassPatcher(patch_kode_transaksi)
        patch_download_efaktur = patch("orj.addons.l10n_id_efaktur_coretax.models.account_move.AccountMove.download_efaktur",
