...
class ReportDayBook(models.AbstractModel):
    _name = 'report.or_account_daily_reports.report_daybook'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        date_from = fields.Date.fror_string(form_data['date_from'])
        date_to = fields.Date.fror_string(form_data['date_to'])
        codes = []
