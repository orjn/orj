from orj.tests import TransactionCase, tagged, users
...
class TestLinkTracker(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.website_1, cls.website_2 = cls.env['website'].create([
            {
                'name': 'website 1',
                'domain': 'https://maincompany.orj.net',
                'company_id': cls.company_1.id
            },
            {
                'name': 'Website 2',
                'domain': 'https://secondarycompany.orj.net',
