...
from orj.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from orj.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("orj.addons.base.models.ir_http")
    ...
    @mute_logger('orj.addons.base.models.ir_http', 'orj.addons.sms.controllers.main', 'orj.http')
