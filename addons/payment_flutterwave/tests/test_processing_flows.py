...
from orj.addons.payment_flutterwave.controllers.main import FlutterwaveController
from orj.addons.payment_flutterwave.tests.common import FlutterwaveCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(FlutterwaveCommon, PaymentHttpCommon):

    @mute_logger('orj.addons.payment_flutterwave.controllers.main')
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'orj.addons.payment_flutterwave.controllers.main.FlutterwaveController.'
