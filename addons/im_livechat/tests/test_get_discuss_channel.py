...
from orj.addons.im_livechat.tests.common import TestImLivechatCommon
...
class TestGetDiscussChannel(TestImLivechatCommon, MailCommon):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        with patch('orj.http.GeoIP.country_code', new_callable=PropertyMock(return_value=belgium.code)):
