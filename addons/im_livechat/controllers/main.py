...
from orj import http, tools, _, release
from orj.exceptions import UserError
from orj.http import request
from orj.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/orj_ui_icons', type='http', auth='none', cors="*")
    def orj_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/orj_ui_icons/fonts/orj_ui_icons.woff2').get_response()
