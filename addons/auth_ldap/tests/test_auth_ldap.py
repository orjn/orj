...
import orj
from orj.modules.registry import Registry, DummyRLock
from orj.tests.common import BaseCase, tagged, get_db_name
...
class TestAuthLDAP(BaseCase):
    ...
    def test_auth_ldap(self):
            ...
            return [
                {
                    ...
                    "ldap_binddn": "cn=admin,dc=orj,dc=com",
                    "ldap_password": "admin",
                    "ldap_filter": "cn=%s",
                    "ldap_base": "dc=orj,dc=com",
                    "user": (6, "Marc Demo"),
                    "create_user": True,
                    "ldap_tls": False,
                }
        ...
        def _authenticate(*args, **kwargs):
            return (
                "cn=test_ldap_user,dc=orj,dc=com",
                {
                    "sn": [b"test_ldap_user"],
                    "cn": [b"test_ldap_user"],
        ...
        session = orj.http.root.session_store.get(res.cookies["session_id"])
        self.assertEqual(
