...
class TestEdiXmls(TestEsEdiCommon):
    ...
    def test_010_out_invoice_s_iva10b_s_iva21s(self):
        ...
        with freeze_time(self.frozen_today), \
             patch('orj.addons.l10n_es_edi_sii.models.account_edi_format.AccountEdiFormat._l10n_es_edi_call_web_service_sign',
    ...
    def test_170_in_invoice_dua(self):
        ...
        with freeze_time(self.frozen_today), patch(
                'orj.addons.l10n_es_edi_sii.models.account_edi_format.AccountEdiFormat._l10n_es_edi_call_web_service_sign',
                new=mocked_l10n_es_edi_call_web_service_sign
        ):
            invoice = self.create_invoice(
                move_type='in_invoice',
