...
from orj.tools import html_escape, zeep
...
class PatchedHTTPAdapter(requests.adapters.HTTPAdapter):
    ...
    def cert_verify(self, conn, url, verify, cert):
        ...
        # In our case, cert is an orj record 'certificate.certificate' so not a path to a file.
    ...
    def get_connection(self, url, proxies=None):
        ...
        def patched_load_cert_chain(l10n_es_orj_certificate, keyfile=None, password=None):
            certificate = l10n_es_orj_certificate
