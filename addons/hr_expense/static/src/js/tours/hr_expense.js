...
},
{
    ...
    content: markup(_t("Ready? You can save it manually or discard modifications from here. You don't <em>need to save</em> - Orj will save eveyrthing for you when you navigate.")),
    tooltipPosition: 'bottom',
    run: "click",
