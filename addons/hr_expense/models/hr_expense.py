...
from orj import api, fields, Command, models, _
from orj.exceptions import UserError, ValidationError
from orj.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default orj rate when the following change:
