...
from orj.tools.pdf import OrjPdfFileReader, OrjPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense_sheet':
            ...
            for expense_sheet in expense_sheets:
                ...
                expense_report = OrjPdfFileReader(stream, strict=False)
                output_pdf = OrjPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = OrjPdfFileReader(attachment_stream, strict=False)
