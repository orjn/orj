...
from orj.addons.payment_aps import const
...
class PaymentProvider(models.Model):
    ...
    def _aps_calculate_signature(self, data, incoming=True):
        ...
        :param bool incoming: Whether the signature must be generated for an incoming (APS to Orj)
                              or outgoing (Orj to APS) communication.
