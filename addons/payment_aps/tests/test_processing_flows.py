...
from orj.addons.payment_aps.controllers.main import APSController
from orj.addons.payment_aps.tests.common import APSCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(APSCommon):

    @mute_logger('orj.addons.payment_aps.controllers.main')
    def test_redirect_notification_triggers_processing(self):
        ...
        with patch(
            'orj.addons.payment_aps.controllers.main.APSController._verify_notification_signature'
        ), patch(
