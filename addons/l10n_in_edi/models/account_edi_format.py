...
from orj.tools import html_escape, float_is_zero, float_compare
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_in_edi_post_invoice(self, invoice):
        ...
        if response.get("error"):
            ...
            if "1005" in error_codes:
                ...
                # This happen when authenticate called from another orj instance with same credentials (like. Demo/Test)
            ...
            if "2150" in error_codes:
                ...
                if not response.get("error"):
                    ...
                    invoice.message_post(author_id=orjbot.id, body=Markup(_(
    ...
    def _l10n_in_edi_authenticate(self, company):
        ...
        # validity data-time in Indian standard time(UTC+05:30) so remove that gap and store in orj
        if "data" in response:
