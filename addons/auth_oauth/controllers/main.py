...
from orj import api, http, SUPERUSER_ID, _
from orj.exceptions import AccessDenied
from orj.http import request, Response
from orj import registry as registry_get
from orj.tools.misc import clean_context

from orj.addons.auth_signup.controllers.main import AuthSignupHome as Home
from orj.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/orj/action-%s' % action
            elif menu:
                url = '/orj?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Orj Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_orj')
            except ValueError:
