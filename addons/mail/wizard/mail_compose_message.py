...
from orj import _, api, fields, models, Command, tools
from orj.exceptions import UserError, ValidationError
from orj.osv import expression
from orj.tools.mail import is_html_empty, email_normalize, email_split_and_format
from orj.addons.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Orj domain (list of leaves) """
        self.ensure_one()
