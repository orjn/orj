...
Communicate with your colleagues/customers/guest within Orj.
...
from Orj itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Orj system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Orj documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Orj integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Orj, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_orj_sfu': [
            'mail/static/lib/orj_sfu/orj_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/orj_ui_icons/style.css',
