...
from orj.tests.common import JsonRpcException, new_test_user, tagged
...
class TestTranslationController(HttpCaseWithUserDemo):
    ...
    def test_access_right(self):
        ...
        with self.assertRaises(JsonRpcException, msg="orj.exceptions.AccessError"), mute_logger("orj.http"):
            self._mock_translation_request({"message_id": self.message.id})
