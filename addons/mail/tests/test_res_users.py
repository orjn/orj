...
from orj.addons.base.models.res_users import Users
...
from orj.tests import RecordCapturer, tagged, users
...
class TestUser(MailCommon):
    ...
    def test_notification_type_constraint(self):
        with self.assertRaises(IntegrityError, msg='Portal user can not receive notification in Orj'):
            mail_new_test_user(
                self.env,
