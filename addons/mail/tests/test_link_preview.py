...
from orj.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/orj", 0),
                ("http://localhost:8069/", "http://localhost:8069/orj/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/orj-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.orj.net/", "https://www.orj.net/web", 0),
                ("https://www.orj.net/", "https://www.orj.net/orj", 0),
                ("https://www.orj.net/", "https://www.orj.net/orj/", 0),
                ("https://www.orj.net/", "https://www.orj.net/orj?debug=assets", 0),
                ("https://www.orj.net/", "https://www.orj.net/orj#anchor", 0),
                ("https://www.orj.net/", "https://www.orj.net/orj-experience", 1),
                ("https://www.orj.net/", "https://www.orj.net/orj/1519/tasks/4102866", 0),
                ("http://www.orj.net/", "https://www.orj.net/orj/1519/tasks/4102866", 1),
                ("https://www.orj.net/", "https://wwwaorj.net/orj/", 1),
                ("https://www.orj.net/", "https://www.orj.net/chat/", 0),
                ("https://www.orj.net/", "https://www.orj.net/chat/5/bFtIfYHRco", 0),
                ("http://www.orj.net/", "https://www.orj.net/chat/5/bFtIfYHRco", 1),
                ("https://clients.orj.net/", "https://www.orj.net/orj/1519/tasks/4102866", 1),
                ("https://clients.orj.net/", "https://www.orj.net/chat/5/bFtIfYHRco", 1),
            ]
