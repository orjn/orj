...
from orj.tests import tagged, new_test_user
from orj.addons.bus.tests.common import WebsocketCase
...
class TestBusPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"orj-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
