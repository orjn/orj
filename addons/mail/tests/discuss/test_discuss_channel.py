...
from orj.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from orj.tests import HttpCase, tagged, users
from orj.tools import html_escape, mute_logger
