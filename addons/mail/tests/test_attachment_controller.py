...
import orj
from orj.tools import file_open, mute_logger
from orj.addons.mail.tests.test_controller_common import TestControllerCommon
...
class TestAttachmentController(TestAttachmentControllerCommon):
    ...
    def test_send_attachment_without_body(self):
        self.start_tour("/orj/discuss", "create_thread_for_attachment_without_body",login="admin")
