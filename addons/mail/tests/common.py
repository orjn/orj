...
from orj.addons.base.models.ir_mail_server import IrMailServer
from orj.addons.base.tests.common import MockSmtplibCase
from orj.addons.bus.models.bus import ImBus, json_dump
from orj.addons.mail.models.mail_mail import MailMail
from orj.addons.mail.models.mail_message import Message
from orj.addons.mail.models.mail_notification import MailNotification
from orj.addons.mail.models.res_users import Users
from orj.addons.mail.tools.discuss import Store
from orj.tests import common, RecordCapturer, new_test_user
from orj.tools import mute_logger
from orj.tools.mail import (
    email_normalize, email_split_and_format_normalize, formataddr
)
from orj.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("orj.addons.base.models.ir_module", "orj.tools.translate"):
