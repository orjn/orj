/** @orj-module alias=@mail/../tests/helpers/mock_server/models/res_users default=false */
    ...
    _mockResUsers__init_store_data() {
        const res = {
            Store: {
                ...
                orjbot: this._mockResPartnerMailPartnerFormat(this.orjbotId).get(this.orjbotId),
            },
        };
