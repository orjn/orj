...
import { delay } from "@orj/hoot-dom";
...
registry.category("web_tour.tours").add("mail_template_dynamic_placeholder_tour", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".note-editable.orj-editor-editable",
            async run(actions) {
        ...
        },
        {
            ...
            trigger: `.note-editable.orj-editor-editable t[t-out="object.company_name"]:contains("defValue")`,
            run: "click",
        },
        {
