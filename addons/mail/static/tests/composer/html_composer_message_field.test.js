...
import { beforeEach, expect, test } from "@orj/hoot";
import {
...
test("media dialog: upload", async function () {
    ...
    const anchorNode = queryOne(".orj-editor-editable div.o-paragraph");
...
test("mention a partner", async () => {
    ...
    const anchorNode = queryOne(`[name='body'] .orj-editor-editable div.o-paragraph`);
    setSelection({ anchorNode, anchorOffset: 0 });
    ...
    await press("enter");
    expect("[name='body'] .orj-editor-editable").toHaveInnerHTML(`
    <div class="o-paragraph">
        <a target="_blank" data-oe-protected="true" contenteditable="false" href="https://www.hoot.test/orj/res.partner/17" class="o_mail_redirect" data-oe-id="17" data-oe-model="res.partner">
            @Mitchell Admin
        </a>
    </div>`);
});
