...
import { after, before, beforeEach, expect, test } from "@orj/hoot";
import { press, queryOne } from "@orj/hoot-dom";
import { animationFrame, enableTransitions } from "@orj/hoot-mock";
import {
    contains,
    defineModels,
    fields,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".orj-editor-editable").toHaveInnerHTML("<h1> first </h1>");
