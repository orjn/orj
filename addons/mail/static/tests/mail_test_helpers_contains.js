/** @orj-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@orj/hoot";
import { queryAll, queryFirst } from "@orj/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|OrjEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when OrjEnv, special key `target`. See @start
