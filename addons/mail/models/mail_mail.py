...
from orj import _, api, fields, models, modules, SUPERUSER_ID, tools
...
class MailMail(models.Model):
    ...
    auto_delete = fields.Boolean(
        'Auto Delete',
        help="This option permanently removes any track of email after it's been sent, including from the Technical menu in the Settings, in order to preserve storage space of your Orj database.")
        ...
        for mail_server_id, alias_domain_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an Orj MailDeliveryException
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                if res:  # mail has been sent at least once, no major exception occurred
                    ...
                    # see revid:odo@orj.net-20120622152536-42b2s28lvdv3odyr in 6.1
