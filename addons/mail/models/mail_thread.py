...
from orj import _, api, exceptions, fields, models, Command
from orj.addons.mail.tools.discuss import Store
from orj.addons.mail.tools.web_push import push_to_end_point, DeviceUnreachableError
from orj.exceptions import MissingError, AccessError
...
class MailThread(models.AbstractModel):
    ...
    def _detect_write_to_catchall(self, msg_dict):
        ...
        # (see orj/orj#161782), to clean when reaching master
    ...
    def _message_route_process(self, message, message_dict, routes):
        ...
        for model, thread_id, custom_values, user_id, alias in routes or ():
            ...
            # switch to orjbot for all incoming message creation
            ...
            for x in ('from', 'to', 'cc', 'recipients', 'references', 'in_reply_to', 'x_orj_message_id',
            ...
            if thread_root._name == 'mail.thread':  # message with parent_id not linked to record
                ...
                # parsing should find an author independently of user running mail gateway, and ensure it is not orjbot
    ...
    def _notify_by_email_get_base_mail_values(self, message, additional_values=None):
        ...
        # SES SMTP may replace Message-Id and In-Reply-To refers an internal ID not stored in Orj)
    ...
    def _notify_by_web_push_prepare_payload(self, message, msg_vals=False):
        ...
        icon = '/web/static/img/orj-icon-192x192.png'
    ...
    def _extract_partner_ids_for_notifications(self, message, msg_vals, recipients_data):
        ...
        # never send to author and to people outside Orj (email), except comments
        pids = set()
    ...
    def _message_auto_subscribe_followers(self, updated_values, default_subtype_ids):
        ...
        with track_visibility set. Since Orj v7 it is considered as being
