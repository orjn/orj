...
from orj import _, api, Command, fields, models, modules, tools
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- Handle in Orj: notifications appear in your Orj Inbox")

    _sql_constraints = [(
        "notification_type",
        "CHECK (notification_type = 'email' OR NOT share)",
        "Only internal user can receive notifications in Orj",
    )]
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing OrjBot data is considered acceptable
                "orjbot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
