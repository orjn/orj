...
from orj.tests import Form, HttpCase, new_test_user, tagged
...
class TestSaleProject(HttpCase, TestSaleProjectCommon):
    ...
    def test_task_create_sol_ui(self):
        self.start_tour('/orj', 'task_create_sol_tour', login='admin')

    def test_project_create_sol_ui(self):
        self.start_tour('/orj', 'project_create_sol_tour', login='admin')
