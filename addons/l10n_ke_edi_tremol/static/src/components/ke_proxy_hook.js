...
export function useKEProxy({onAllSent}) {
    ...
    async function postInvoices(invoices) {
        ...
        // Ping the server to prevent posting to the device when there is no connection to the orj server
        try {
            ...
            try {
                ...
                switch (progress) {
                    ...
                    case 'parseResponse':
                        ...
                        break;
                    case 'updateInvoice':
                        state.message = _t("Error trying to connect to Orj. Check your internet connection. Error message: %s", e.message);
                        break;
                    default:
