...
from orj.addons.mail.tools import mail_validation
...
from orj.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email, SQL
...
PLS_COMPUTE_BATCH_STEP = 50000  # orj.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
