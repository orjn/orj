...
from orj.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('orj.models.unlink', 'orj.addons.crm.models.crm_team', 'orj.addons.crm.models.crm_team_member')
    def test_assign_perf_duplicates(self):
        ...
        with self.with_user('user_sales_manager'):
            self.env.user._is_internal()  # warmup the cache to avoid inconsistency between community an ore
