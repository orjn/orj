...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@orj.net', 'fp@orj.net'),
            ('fp.alias@mail.orj.net', 'fp.alias@mail.orj.net'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.orj.net', 'subdomain.orj.net'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@ORJ.COM>',
                'name': 'Dupe1 of fp@orj.net (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@orj.net',
                'name': 'Dupe2 of fp@orj.net (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.orj.net',
                'name': 'Dupe3 of fp@orj.net (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                ...
                'name': 'Dupe4 of fp@orj.net (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@orj.net (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@orj.net (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@orj.net')
        self.assertEqual(lead_generic.email_normalized, 'fp@orj.net')
