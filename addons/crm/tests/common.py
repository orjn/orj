...
from orj.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from orj.addons.mail.tests.common import MailCase, mail_new_test_user
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('orj.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
