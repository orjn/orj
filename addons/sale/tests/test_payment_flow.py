...
from orj.addons.sale.controllers.portal import PaymentPortal
from orj.addons.sale.tests.common import SaleCommon
...
class TestSalePayment(AccountPaymentCommon, SaleCommon, PaymentHttpCommon):
    ...
    def test_11_so_payment_link(self):
        ...
        with patch(
            'orj.addons.payment.controllers.portal.PaymentPortal'
    ...
    def test_invoice_is_final(self):
        ...
        with mute_logger('orj.addons.sale.models.payment_transaction'), patch(
            'orj.addons.sale.models.sale_order.SaleOrder._create_invoices',
    ...
    def test_partial_payment_confirm_order(self):
        ...
        with patch(
            'orj.addons.sale.models.sale_order.SaleOrder._send_order_notification_mail',
