from orj.addons.account.tests.test_taxes_tax_totals_summary import TestTaxesTaxTotalsSummary
from orj.addons.sale.tests.common import TestTaxCommonSale
