...
from orj import fields, http, _
from orj.exceptions import AccessError, MissingError, ValidationError
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def portal_order_page(
        ...
        **kw
        ...
        backend_url = f'/orj/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
        values = {
