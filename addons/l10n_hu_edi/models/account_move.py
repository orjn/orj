...
from orj.tools import formatLang, float_compare, float_is_zero, float_round, float_repr, cleanup_xml_node, groupby
from orj.tools.misc import split_every
from orj.addons.base_iban.models.res_partner_bank import normalize_iban
from orj.addons.l10n_hu_edi.models.l10n_hu_edi_connection import format_bool, L10nHuEdiConnection, L10nHuEdiConnectionError
...
class AccountMove(models.Model):
    ...
    def _l10n_hu_edi_query_status_single_batch(self, connection):
        ...
        for processing_result in results['processing_results']:
            ...
            if not invoice:
                _logger.error(_('Could not match NAV transaction_code %(code)s, index %(index)s to an invoice in Orj',
