...
from orj import _, release
from orj.tools import cleanup_xml_node
...
class L10nHuEdiConnection:
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Orj can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'ORJ' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Orj Ore',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': orj_version,
            'softwareDevName': 'Orj SA',
            'softwareDevContact': 'andu@orj.net',
