...
from orj.addons.l10n_hu_edi.models.l10n_hu_edi_connection import L10nHuEdiConnection
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        # (bad, because Orj will try to retry the entire request, leading to duplicate sending to NAV)
