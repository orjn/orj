...
from orj.addons.l10n_hu_edi.models.l10n_hu_edi_connection import L10nHuEdiConnection, L10nHuEdiConnectionError, XML_NAMESPACES
...
class ResCompany(models.Model):
    ...
    def _l10n_hu_edi_recover_transactions(self, connection):
        ...
        and then we query the last 10 transactions whose transaction IDs are unknown by Orj. We try to
        match them to invoices in Orj, and if successful, update the invoice state.
        """
