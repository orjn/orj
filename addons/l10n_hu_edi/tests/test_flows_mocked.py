...
from orj.addons.l10n_hu_edi.tests.common import L10nHuEdiTestCommon
...
class L10nHuEdiTestFlowsMocked(L10nHuEdiTestCommon, TestAccountMoveSendCommon):
    ...
    def patch_post(self, responses=None):
        ...
        with mock.patch('orj.addons.l10n_hu_edi.models.l10n_hu_edi_connection.requests.Session', side_effect=MockedSession, autospec=True):
            yield
