...
from orj.tests.common import tagged, freeze_time
...
class TestPeppolMessage(TestAccountMoveSendCommon):
    ...
    @patch('orj.addons.account_peppol.models.res_partner.ResPartner._check_document_type_support', return_value=False)
    ...
    def test_silent_error_while_creating_xml(self):
        ...
        with patch(
            'orj.addons.account_edi_ubl_cii.models.account_edi_xml_ubl_20.AccountEdiXmlUBL20._export_invoice_constraints',
