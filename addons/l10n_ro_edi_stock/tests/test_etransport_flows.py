...
from orj.addons.l10n_ro_edi_stock.tests.common import TestL10nRoEdiStockCommon

from unittest.mock import patch
from freezegun import freeze_time


@patch('orj.addons.l10n_ro_edi_stock.models.etransport_api.ETransportAPI._make_etransport_request')
